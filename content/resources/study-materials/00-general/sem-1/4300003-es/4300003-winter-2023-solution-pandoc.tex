...
\bottomrule\noalign{}
\endlastfoot
\textbf{Carbon Footprint} & Land needed to absorb CO_{2} emissions \\
...
\begin{verbatim}
flowchart LR
    A[Atmospheric N_{2] {-}{-} B[Nitrogen Fixation]}
    B {-{-} C[Ammonia NH_{3}]}
    C {-{-} D[Nitrification]}
    D {-{-} E[Nitrites NO_{2}^{-}]}
    E {-{-} F[Nitrates NO_{3}^{-}]}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Fixation} & N_{2} \rightarrow NH_{3} & Rhizobium, Azotobacter \\
\textbf{Nitrification} & NH_{3} \rightarrow NO_{2}^{-} \rightarrow NO_{3}^{-} & Nitrosomonas,
Nitrobacter \\
\textbf{Assimilation} & NO_{3}^{-} \rightarrow Proteins & Plants \\
\textbf{Decomposition} & Proteins \rightarrow NH_{3} & Bacteria, fungi \\
\textbf{Denitrification} & NO_{3}^{-} \rightarrow N_{2} & Anaerobic bacteria \\
\end{longtable}
...
\item
  \textbf{Handles high temperatures}: Up to 400^\circC
\end{itemize}
...
\textbf{Time} & 5 days at 20^\circC & 2-3 hours \\
...
\item
  ...
  organic matter
\item
  \textbf{Standard conditions}: 5 days, 20^\circC, dark conditions
\item
...
\item
  ...
  chemically
\item
  \textbf{Oxidizing agent}: K_{2}Cr_{2}O_{7} in acidic medium
\item
...
\tightlist
\item
  \textbf{Primary}: Directly emitted (SO_{2}, CO, particulates)
\item
  \textbf{Secondary}: Formed by reactions (O_{3}, acid rain, smog)
\end{itemize}
...
\item
  \textbf{Capacity}: 10-100 m^{3} for household plants
\item
...
alcohols \\
\textbf{Methanogenesis} & Methane production & 15-30 days & CH_{4} (60\%),
CO_{2} (40\%) \\
\end{longtable}
...
\tightlist
\item
  \textbf{Temperature}: 30-40^\circC (mesophilic)
\item
...
\bottomrule\noalign{}
\endlastfoot
\textbf{High Temperature} & \textgreater150^\circC & Electricity
generation \\
\textbf{Medium Temperature} & 90-150^\circC & Direct heating, cooling \\
\textbf{Low Temperature} & \textless90^\circC & Heat pumps, agriculture \\
\end{longtable}
...
stratosphere \\
\textbf{UV Breakdown} & Photodissociation & CFC + UV \rightarrow Cl + other
products \\
\textbf{Ozone Destruction} & Catalytic cycle & Cl + O_{3} \rightarrow ClO + O_{2} \\
\textbf{Chain Reaction} & Continuous process & ClO + O \rightarrow Cl + O_{2} \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{CO_{2}} & Fossil fuels, deforestation & 76\% & 300-1000 years \\
\textbf{CH_{4}} & Agriculture, landfills & 16\% & 12 years \\
\textbf{N_{2}O} & Fertilizers, combustion & 6\% & 120 years \\
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Temperature} & +1.1^\circC since 1880 & Rising \\
...
\item
  \textbf{Ice core data}: Historical CO_{2} levels
\item
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Definition} & Increase in global average temperature & +1.1^\circC
since pre-industrial \\
\textbf{Primary Cause} & CO_{2} emissions from fossil fuels & 410+ ppm
atmospheric CO_{2} \\
...
\tightlist
\item
  \textbf{Ice-albedo feedback}: Less ice \rightarrow more heat absorption
\item
...
\tightlist
\item
  \textbf{Temperature rise}: 1.5-4.5^\circC by 2100 depending on emissions
\item
...
\textbf{Environmental Impact} & High pollution, CO_{2} emissions & Clean,
minimal emissions \\
...
Carbon credit is a tradeable certificate representing one tonne of CO_{2}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Unit} & 1 credit = 1 tonne CO_{2} equivalent \\
