...
\tightlist
\item
  \textbf{Greenhouse gases}: CO_{2}, CH_{4}, N_{2}O emissions
\item
...
{Highlighting}[]
graph LR
    A[Atmospheric CO_{2] {-}{-}{} B[Photosynthesis]}
    B {-{-}{} C[Plant Biomass]}
...
\tightlist
\item
  \textbf{Photosynthesis}: CO_{2} absorption by plants
\item
  \textbf{Respiration}: CO_{2} release by organisms
\item
  \textbf{Decomposition}: Carbon return to atmosphere
\item
  \textbf{Ocean exchange}: CO_{2} dissolution in seawater
\end{itemize}
...
\item
  \textbf{Temperature}: Can reach 70-85^\circC at bottom
\end{itemize}
...
\tightlist
\item
  \textbf{Carbon dioxide (CO_{2})}: 76\% of emissions
\item
  \textbf{Methane (CH_{4})}: 16\% of emissions
\item
  \textbf{Nitrous oxide (N_{2}O)}: 6\% of emissions
\item
...
\tightlist
\item
  \textbf{CO_{2}}: Fossil fuel burning, deforestation
\item
  \textbf{CH_{4}}: Agriculture, landfills, livestock
\item
  \textbf{N_{2}O}: Fertilizers, fossil fuel combustion
\end{itemize}
...
\tightlist
\item
  \textbf{CO_{2}}: Reference (GWP = 1)
\item
  \textbf{CH_{4}}: 25 times CO_{2}
\item
  \textbf{N_{2}O}: 298 times CO_{2}
\end{itemize}
...
\item
  \textbf{Gas production}: 50-70\% methane, 30-40\% CO_{2}
\end{itemize}
...
\tightlist
\item
  \textbf{Temperature}: 30-40^\circC optimal
\item
...
\end{mnemonicbox}
\subsection*{Question 5(a) [4 marks]}\label{q5a}
...
\tightlist
\item
  \textbf{Temperature rise}: 1.1^\circC since pre-industrial times
\item
...
\end{mnemonicbox}
\subsection*{Question 5(c) [3 marks]}\label{q5c}
...
\end{mnemonicbox}
\subsection*{Question 5(d) [3 marks]}\label{q5d}
