...
\bottomrule\noalign{}
\endlastfoot
\textbf{કાર્બન ફૂટપ્રિન્ટ} & CO_{2} ઉત્સર્જન શોષવા માટે જરૂરી જમીન \\
...
\begin{verbatim}
flowchart LR
    A[વાતાવરણીય N_{2] {-}{-} B[નાઈટ્રોજન સ્થિરીકરણ]}
    B {-{-} C[અમોનિયા NH_{3}]}
    C {-{-} D[નાઈટ્રિફિકેશન]}
    D {-{-} E[નાઈટ્રાઈટ NO_{2}^{-}]}
    E {-{-} F[નાઈટ્રેટ NO_{3}^{-}]}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{સ્થિરીકરણ} & N_{2} \rightarrow NH_{3} & રાઈઝોબિયમ, એઝોટોબેક્ટર \\
\textbf{નાઈટ્રિફિકેશન} & NH_{3} \rightarrow NO_{2}^{-} \rightarrow NO_{3}^{-} & નાઈટ્રોસોમોનાસ, નાઈટ્રોબેક્ટર \\
\textbf{આત્મસાત્કરણ} & NO_{3}^{-} \rightarrow પ્રોટીન & છોડવા \\
\textbf{વિઘટન} & પ્રોટીન \rightarrow NH_{3} & બેક્ટેરિયા, ફૂગ \\
\textbf{ડી-નાઈટ્રિફિકેશન} & NO_{3}^{-} \rightarrow N_{2} & એનેરોબિક બેક્ટેરિયા \\
\end{longtable}
...
\item
  \textbf{ઉચ્ચ તાપમાન સંભાળે}: 400^\circC સુધી
\end{itemize}
...
\textbf{સમય} & 20^\circC પર 5 દિવસ & 2-3 કલાક \\
...
\item
  ...
  ઓક્સિજન
\item
  \textbf{પ્રમાણભૂત પરિસ્થિતિઓ}: 5 દિવસ, 20^\circC, અંધકારની સ્થિતિ
\item
...
\item
  ...
  સમકક્ષ
\item
  \textbf{ઓક્સિડાઈઝિંગ એજન્ટ}: અમ્લીય માધ્યમમાં K_{2}Cr_{2}O_{7}
\item
...
\tightlist
\item
  \textbf{પ્રાથમિક}: સીધા ઉત્સર્જિત (SO_{2}, CO, કણો)
\item
  \textbf{ગૌણ}: પ્રતિક્રિયાઓ દ્વારા રચાય (O_{3}, અમ્લ વરસાદ, ધુમ્મસ)
\end{itemize}
...
\item
  \textbf{ક્ષમતા}: ઘરેલુ પ્લાન્ટ માટે 10-100 m^{3}
\item
...
\textbf{મેથેનોજેનેસિસ} & મેથેન ઉત્પાદન & 15-30 દિવસ & CH_{4} (60\%), CO_{2} (40\%) \\
\end{longtable}
...
\tightlist
\item
  \textbf{તાપમાન}: 30-40^\circC (મેસોફિલિક)
\item
...
\bottomrule\noalign{}
\endlastfoot
\textbf{ઉચ્ચ તાપમાન} & \textgreater150^\circC & વિજળી ઉત્પાદન \\
\textbf{મધ્યમ તાપમાન} & 90-150^\circC & સીધું હીટિંગ, કૂલિંગ \\
\textbf{નીચા તાપમાન} & \textless90^\circC & હીટ પંપ, કૃષિ \\
\end{longtable}
...
\textbf{UV વિભાજન} & ફોટોડિસોસિએશન & CFC + UV \rightarrow Cl + અન્ય ઉત્પાદનો \\
\textbf{ઓઝોન વિનાશ} & કેટેલિટિક ચક્ર & Cl + O_{3} \rightarrow ClO + O_{2} \\
\textbf{શૃંખલા પ્રતિક્રિયા} & સતત પ્રક્રિયા & ClO + O \rightarrow Cl + O_{2} \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{CO_{2}} & અવશેષ ઇંધણ, વનનાશ & 76\% & 300-1000 વર્ષ \\
\textbf{CH_{4}} & કૃષિ, લેન્ડફિલ & 16\% & 12 વર્ષ \\
\textbf{N_{2}O} & ખાતર, દહન & 6\% & 120 વર્ષ \\
...
\bottomrule\noalign{}
\endlastfoot
\textbf{તાપમાન} & 1880 થી +1.1^\circC & વધતું \\
...
\item
  \textbf{બરફના કોર ડેટા}: ઐતિહાસિક CO_{2} સ્તર
\item
...
+1.1^\circC \\
\textbf{પ્રાથમિક કારણ} & અવશેષ ઇંધણોથી CO_{2} ઉત્સર્જન & 410+ ppm વાતાવરણીય
CO_{2} \\
...
\tightlist
\item
  \textbf{બરફ-એલ્બેડો ફીડબેક}: ઓછું બરફ \rightarrow વધુ ગરમી શોષણ
\item
...
\tightlist
\item
  \textbf{તાપમાન વધારો}: ઉત્સર્જનના આધારે 2100 સુધીમાં 1.5-4.5^\circC
\item
...
\textbf{પર્યાવરણીય અસર} & ઉચ્ચ પ્રદૂષણ, CO_{2} ઉત્સર્જન & સ્વચ્છ, ન્યૂનતમ ઉત્સર્જન \\
...
વાતાવરણમાંથી એક ટન CO_{2} સમકક્ષ ઘટાડેલ અથવા દૂર કરેલનું પ્રતિનિધિત્વ કરતું વેપારીલાયક
પ્રમાણપત્ર છે.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{એકમ} & 1 ક્રેડિટ = 1 ટન CO_{2} સમકક્ષ \\
