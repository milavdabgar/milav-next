...
\vspace{-5pt}
\captionof{table}{પારિસ્થિતિક પિરામિડના પ્રકારો}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{સંખ્યાનો પિરામિડ} & દરેક સ્તરે જીવોની સંખ્યા દર્શાવે છે & વૃક્ષો \rightarrow જંતુઓ \rightarrow
પક્ષીઓ \\
...
\end{solutionbox}
\begin{mnemonicbox}
``સંખ્યા-બાયોમાસ-ઊર્જા ઉપર વહે છે''
...
\bottomrule\noalign{}
\endlastfoot
\textbf{નાઇટ્રોજન સ્થિરીકરણ} & N2 \rightarrow NH3 & રાયઝોબિયમ બેક્ટેરિયા \\
\textbf{નાઇટ્રિફિકેશન} & NH3 \rightarrow NO3 & નાઇટ્રોસોમોનાસ, નાઇટ્રોબેક્ટર \\
\textbf{ડિનાઇટ્રિફિકેશન} & NO3 \rightarrow N2 & ડિનાઇટ્રિફાઇંગ બેક્ટેરિયા \\
\end{longtable}
...
\end{solutionbox}
\begin{mnemonicbox}
``બેક્ટેરિયા નાઇટ્રોજન ઠીક કરે છે, છોડ વાપરે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``લગાવો, સંરક્ષિત કરો, ટકાઉપણાનો અભ્યાસ કરો''
...
\end{solutionbox}
\begin{mnemonicbox}
``ગુરુત્વાકર્ષણ ભારે કણો સ્થાપિત કરે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``ભેગું કરો, પરિવહન કરો, ઉપચાર કરો, મોનિટર કરો''
...
\end{solutionbox}
\begin{mnemonicbox}
``ધ્વનિ આરોગ્ય અને વસવાટને હાનિ પહોંચાડે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``રાસાયણિક, જૈવિક, ભૌતિક, કિરણોત્સર્ગી''
...
\end{solutionbox}
\begin{mnemonicbox}
``એકત્ર કરો, ડિસમેન્ટલ કરો, પુનઃપ્રાપ્ત કરો, સુરક્ષિત નિકાલ
કરો''
...
\textbf{ટેસ્ટ સમયગાળો} & 20^\circC પર 5 દિવસ \\
\end{longtable}
...
\end{solutionbox}
\begin{mnemonicbox}
``બેક્ટેરિયા ઓક્સિજન માંગ પ્રદૂષણ માપે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``પરંપરાગત પ્રદૂષિત કરે છે, નવીકરણીય ટકાવે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``સુરક્ષા, પર્યાવરણ, અર્થવ્યવસ્થાને નવીકરણીય જોઈએ''
...
\bottomrule\noalign{}
\endlastfoot
\textbf{ઉચ્ચ તાપમાન} & \textgreater150^\circC & પાવર જનરેશન \\
\textbf{મધ્યમ તાપમાન} & 90-150^\circC & સીધું ગરમ કરવું \\
\textbf{નીચો તાપમાન} & \textless90^\circC & હીટ પમ્પ \\
\end{longtable}
...
\end{solutionbox}
\begin{mnemonicbox}
``પૃથ્વીની ગરમી ઘરોને પાવર આપે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``સૂર્ય સિલિકોન પર પ્રહાર કરે છે, પ્રવાહ ચાલુ કરે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``ગેસો ગરમી ફસાવે છે, પૃથ્વી ગરમ થાય છે''
...
\textbf{પેરિસ એગ્રિમેન્ટ} & 2015 & ગ્લોબલ વોર્મિંગ 1.5^\circC સુધી મર્યાદિત કરવું \\
...
\end{solutionbox}
\begin{mnemonicbox}
``ક્યોટો, પેરિસ, મોન્ટ્રીયલ હવામાનનું સંરક્ષણ કરે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``CO2, CH4, N2O, F-ગેસો પૃથ્વીને ગરમ કરે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``CFCs ચઢે છે, ક્લોરિન ઓઝોન કાપે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``માનવીય ક્રિયાઓ પૃથ્વીને ગરમ કરે છે, દરેકને અસર થાય છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``ફાર્મ પોન્ડ પાકો માટે વરસાદ સંગ્રહ કરે છે''
...
\end{solutionbox}
\begin{mnemonicbox}
``ગ્રીન લક્ષ્યાંકો: ઊર્જા, પાણી, સામગ્રી, પર્યાવરણ''
...
\end{solutionbox}
\begin{mnemonicbox}
``પકડો, પહોંચાડો, સંગ્રહ કરો, ફિલ્ટર કરો, વાપરો''
...
\end{solutionbox}
\begin{mnemonicbox}
``જીવન ચક્ર: કાચો, બનાવો, વાપરો, નિકાલ કરો''
...
\end{solutionbox}
\begin{mnemonicbox}
``જૈવવિવિધતા કાયદો: એક્સેસ, લાભ, સંરક્ષણ, સુરક્ષા''
...
\end{solutionbox}
\begin{mnemonicbox}
``ખરેખર ઘટાડો પુનઃઉપયોગ પુનઃહેતુ પુનર્ચક્રણ''
