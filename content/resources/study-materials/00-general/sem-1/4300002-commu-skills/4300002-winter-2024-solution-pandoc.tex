...
\item
\begin{solutionbox}
SMCR Model of Communication was created by \_\_.  C.
  David Berlo
\item
\end{solutionbox}
\begin{solutionbox}
\_\_\_\_\_ is NOT a part of verbal communication.  B.
  Gesture
\item
  Factors that influence communication negatively are called \_\_\_\_\_
\end{solutionbox}
\begin{solutionbox}
to effective communication.  A. Barriers
\item
...
\end{solutionbox}
\begin{solutionbox}
Encoding is the process of converting thoughts and
...
\vspace{-5pt}
\captionof{table}{Verbal vs.~Non-verbal Communication}
\vspace{-10pt}
  \begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{solutionbox}
This is a semantic barrier or language barrier. It
...
\end{solutionbox}
\begin{solutionbox}
`He' refers to the horse in the poem. The horse
...
\end{solutionbox}
\begin{solutionbox}
Through the phrase ``mind is without fear,'' Tagore
...
\end{solutionbox}
\begin{solutionbox}
Tagore addresses God as `my Father' in the poem
...
\end{solutionbox}
\begin{solutionbox}
Bob and Jimmy had made an appointment to meet at the
...
\end{solutionbox}
\begin{solutionbox}
The shikaris (hunters) were roaming in the forest to
...
\end{solutionbox}
\begin{solutionbox}
Winter season is described in ``Stopping by Woods on
...
\end{solutionbox}
\begin{solutionbox}
The poet doesn't specify what promises he refers to
...
\end{solutionbox}
\begin{solutionbox}
By ``knowledge is free,'' Tagore envisions a society
...
\end{solutionbox}
\begin{solutionbox}
``Narrow domestic walls'' refers to artificial
...
\end{solutionbox}
\begin{solutionbox}
Bob realized the cop wasn't Jimmy when the
...
\end{solutionbox}
\begin{solutionbox}
The phrase ``guardian of peace'' in ``After Twenty
...
\end{solutionbox}
\begin{solutionbox}
In ``The Leopard,'' the author held a critical
...
\end{solutionbox}
\begin{solutionbox}
The ravine in ``The Leopard'' was described as a
...
\item
\begin{solutionbox}
Sumit / is / happy.  Subject + Verb + Complement (SVC)
\item
\end{solutionbox}
\begin{solutionbox}
The monk / opened / his eyes.  Subject + Verb + Object
  (SVO)
\item
\end{solutionbox}
\begin{solutionbox}
I / like / painting.  Subject + Verb + Object (SVO)
\item
\end{solutionbox}
\begin{solutionbox}
Meena / sang / beautifully.  Subject + Verb + Adverb
  (SVA)
\end{enumerate}
...
\item
\begin{solutionbox}
Shital / will write / a letter.  Subject + Verb +
  Object (SVO)
\item
\end{solutionbox}
\begin{solutionbox}
Dr.~Patel / treats / well.  Subject + Verb + Adverb
  (SVA)
\item
\end{solutionbox}
\begin{solutionbox}
Richa / failed.  Subject + Verb (SV)
\item
\end{solutionbox}
\begin{solutionbox}
Ankit / is / an engineer.  Subject + Verb + Complement
  (SVC)
\end{enumerate}
...
\end{solutionbox}
\begin{solutionbox}
You have just posted a photo which is very nice.
\item
...
\end{solutionbox}
\begin{solutionbox}
The villain will kill the hero.
\end{enumerate}
...
\end{solutionbox}
\begin{solutionbox}
Although she was not prepared for her exam, she went
  to watch a movie.
\item
...
\begin{solutionbox}
The Shannon-Weaver model explains how information
...
\end{solutionbox}
\begin{mnemonicbox}
``Source Encodes, Channel Carries, Destination
Decodes''
...
\begin{solutionbox}
Facial expressions and eye contact are powerful forms
of non-verbal communication that often convey emotions more
authentically than words.


\vspace{-5pt}
\captionof{table}{Key Aspects of Facial Expressions and Eye Contact}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{mnemonicbox}
``Face Shows What Words Can't Tell''
...
\item
\begin{solutionbox}
The \_\_\_ visited the stream regularly.  C. forktail
\item
...
\end{solutionbox}
\begin{solutionbox}
The poet described the woods as \_\_\_\_\_\_\_.  A.
  `lovely, dark and deep'
\item
\end{solutionbox}
\begin{solutionbox}
Reason is compared to a clear \_\_\_\_ by Tagore.  A.
  stream
\item
\end{solutionbox}
\begin{solutionbox}
According to Tagore, human should work towards \_\_
  B. perfection
\end{enumerate}
...
\begin{solutionbox}
In Robert Frost's poem, the speaker faces a momentary
conflict between pausing to appreciate natural beauty and fulfilling
responsibilities.


\vspace{-5pt}
\captionof{table}{The Poet's Dilemma}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{mnemonicbox}
``Beauty Beckons, Duty Calls, Journey Continues''
...
\begin{solutionbox}
In ``Where the Mind is Without Fear,'' Tagore envisions
his ideal ``heaven of freedom'' not as an afterlife destination but as a
transformed nation.


\vspace{-5pt}
\captionof{table}{Attributes of Tagore's ``Heaven of Freedom''}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{mnemonicbox}
``Freedom, Unity, Reason, Truth, Perfection''
...
\begin{solutionbox}
Ruskin Bond's ``The Leopard'' conveys powerful messages
about human-nature relationships and coexistence.


\vspace{-5pt}
\captionof{table}{Key Messages in ``The Leopard''}
\vspace{-10pt}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2195}}
...
\end{solutionbox}
\begin{mnemonicbox}
``Respect Nature, Protect Wildlife, Observe
Patiently''
...
\begin{solutionbox}
Communication skills are essential abilities needed to
effectively exchange information and connect with others.


\vspace{-5pt}
\captionof{table}{Need and Applications of Communication Skills}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\vspace{-5pt}
\captionof{table}{Major Types of Communication Barriers}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{mnemonicbox}
``PPSOC: Physical, Psychological, Semantic,
...
\begin{solutionbox}
time, because \_\_\_\_\_.  D. he wanted to give some
  courage to himself
\item
  Bob and Jimmy had their last dinner together at a restaurant named
\end{solutionbox}
\begin{solutionbox}
\_\_.  D. Big Joe Brady's
\item
\end{solutionbox}
\begin{solutionbox}
The owner of woods lives in the \_\_\_\_\_.  C.
  village
\item
\end{solutionbox}
\begin{solutionbox}
The woods are covered with \_\_\_.  A. snow
\item
  The poem `Where the Mind is Without Fear' ends with the line:
\end{solutionbox}
\begin{solutionbox}
``\ldots let my country \_\_\_``.  B. awake
\end{enumerate}
...
\begin{solutionbox}
In ``The Leopard,'' Ruskin Bond expresses deep
emotional distress and environmental concern regarding human impacts on
wildlife.


\vspace{-5pt}
\captionof{table}{Author's Pain and Concern}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{mnemonicbox}
``Witness, Worry, Warn about Wildlife Threats''
...
\begin{solutionbox}
O. Henry's ``After Twenty Years'' presents a powerful
moral conflict between personal loyalty and professional obligation.


\vspace{-5pt}
\captionof{table}{Friendship vs.~Duty Conflict}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{mnemonicbox}
``Promises from Past, Present Principles Prevail''
...
\begin{solutionbox}
Robert Frost's poem explores the tension between
...
\end{solutionbox}
\begin{mnemonicbox}
``Pause, Ponder, Proceed with Purpose''
...
\end{solutionbox}
\begin{solutionbox}
Catalogue is attached with \_\_\_\_\_.  C. Reply to
  inquiry email
\item
...
\begin{solutionbox}
Courtesy and completeness are two essential principles
of effective business communication.


\vspace{-5pt}
\captionof{table}{Courtesy and Completeness in Business Communication}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\begin{solutionbox}
\_\_\_\_\_ is used.  A. Post Script
\item
\end{solutionbox}
\begin{solutionbox}
When can a buyer write a complaint email? \_\_\_\_\_.
  D. All of these
\item
\end{solutionbox}
\begin{solutionbox}
Give full form of C.W.O. \_\_\_\_\_.  A. Cash with
  order
\item
\end{solutionbox}
\begin{solutionbox}
Which of the following is an advantage of an e-mail?
  D. All of these
\end{enumerate}
...
\begin{solutionbox}
Inside address and complimentary close are essential
components of business letter formatting that serve specific functions.


\vspace{-5pt}
\captionof{table}{Inside Address and Complimentary Close}
\vspace{-10pt}
\begin{longtable}[]{@{}
...
\end{solutionbox}
\begin{mnemonicbox}
``Address Who Receives, Close Before You Sign''
