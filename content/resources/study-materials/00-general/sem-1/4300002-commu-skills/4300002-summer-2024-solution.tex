...
\begin{solutionbox}
\textbf{Answer}: In ``After Twenty Years'' by O. Henry, fate brings two
...
\textbf{Table: Themes in ``After Twenty Years''}
...
\textbf{Mnemonic:} ``Friends Face Duty's Divide''
...
\begin{solutionbox}
\textbf{Answer}: The Shannon-Weaver Model explains how information flows
...
\begin{tikzpicture}[node distance=2cm, auto,
    ...
    \node [block, right=of source] (encoder) {Encoder/ Transmitter};
    \node [block, right=of encoder] (channel) {Channel};
    \node [block, right=of channel] (decoder) {Decoder/ Receiver};
...
\textbf{Mnemonic:} ``Send Encode Channel Decode Receive''
...
\begin{solutionbox}
\textbf{Answer}: Communication is the exchange of information, ideas,
and feelings between individuals.

\textbf{Table: Communication Essentials}
...
\textbf{Mnemonic:} ``PLCS: Physical, Language, Cultural, State-of-mind''

\subsection{Alternative Question 1(c) {[}7
marks{]}}\label{alternative-question-1c-7-marks}
...
marks{]}}\label{alternative-question-2a-3-marks}
...
marks{]}}\label{alternative-question-2b-4-marks}
...
marks{]}}\label{alternative-question-2c-7-marks}
...
\item
\begin{solutionbox}
  They / worked / hard. \textbf{Answer}: Subject + Verb + Adverb
\end{solutionbox}
\item
\begin{solutionbox}
  It / was / a very pleasant talk. \textbf{Answer}: Subject + Verb +
  Complement
\end{solutionbox}
\item
\begin{solutionbox}
  Many students / witnessed / a Play. \textbf{Answer}: Subject + Verb +
  Object
\end{solutionbox}
\item
\begin{solutionbox}
  Leopard / roars. \textbf{Answer}: Subject + Verb
\end{solutionbox}
\end{enumerate}
...
marks{]}}\label{alternative-question-3a-3-marks}
...
\item
\begin{solutionbox}
  She / sings / a song. \textbf{Answer}: Subject + Verb + Object
\end{solutionbox}
\item
\begin{solutionbox}
  They / came / suddenly. \textbf{Answer}: Subject + Verb + Adverb
\end{solutionbox}
\item
\begin{solutionbox}
  People / cried. \textbf{Answer}: Subject + Verb
\end{solutionbox}
\item
\begin{solutionbox}
  We / are / Indians. \textbf{Answer}: Subject + Verb + Complement
\end{solutionbox}
\end{enumerate}

\subsection{Alternative Question 3(b) {[}4
marks{]}}\label{alternative-question-3b-4-marks}
...
marks{]}}\label{alternative-question-3c-7-marks}
...
\begin{solutionbox}
\textbf{Answer}: Initially, birds and animals were wary of the author,
...
\begin{solutionbox}
\textbf{Answer}: Jimmy and Bob had their last dinner at ``Big Joe''
...
\begin{solutionbox}
\textbf{Answer}: In Ruskin Bond's ``Leopard,'' the author has two
significant encounters with the magnificent wild cat.

\textbf{Table: The Two Leopard Encounters}
...
\textbf{Mnemonic:} ``Watch, Wait, Withdraw''
...
\begin{solutionbox}
\textbf{Answer}: Robert Frost's poem conveys the tension between
...
\textbf{Mnemonic:} ``Pause, Ponder, Proceed''
...
\begin{solutionbox}
\textbf{Answer}: In his poem, Tagore envisions an ideal free India
characterized by intellectual and spiritual freedom.

\textbf{Table: Tagore's Vision of Freedom}
...
\textbf{Mnemonic:} ``Freedom Through Knowledge, Truth, and Reason''

\subsection{Alternative Question 4(a) {[}3
marks{]}}\label{alternative-question-4a-3-marks}
...
\begin{solutionbox}
  \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_. \textbf{Answer}: (c)
  Rabindranath Tagore
\end{solutionbox}
\item
\begin{solutionbox}
  What made Bob realize that the Cop wasn't Jimmy? \textbf{Answer}: (d)
  His jaw
\end{solutionbox}
\item
  ``Stopping by Woods on a Snowy Evening'' is written by the Poet
\begin{solutionbox}
  \_\_\_\_\_\_\_\_\_\_\_. \textbf{Answer}: (d) Robert Frost
\end{solutionbox}
\item
  Apart from the author, \_\_\_\_\_\_\_\_\_\_ was the regular visitor of
\begin{solutionbox}
  the stream. \textbf{Answer}: (b) Forktail
\end{solutionbox}
\end{enumerate}

\subsection{Alternative Question 4(b) {[}4
marks{]}}\label{alternative-question-4b-4-marks}
...
\begin{solutionbox}
\textbf{Answer}: The author approached wildlife with patience and
...
\begin{solutionbox}
\textbf{Answer}: The horse shakes its harness bells questioningly,
...
\begin{solutionbox}
\textbf{Answer}: Tagore envisions an India free from divisions based on
...
marks{]}}\label{alternative-question-4c-7-marks}
...
\begin{solutionbox}
\textbf{Answer}: O. Henry's ``After Twenty Years'' offers profound life
lessons through its ironic twist.

\textbf{Table: Key Lessons from ``After Twenty Years''}
...
\textbf{Mnemonic:} ``Time Changes Paths, Choices Matter''
...
\begin{solutionbox}
\textbf{Answer}: Though written before independence, Tagore's poem
outlines his vision for a free India.

\textbf{Table: Tagore's Vision for Independent India}
...
\textbf{Mnemonic:} ``Free Minds, United People, Progressive Nation''
...
\begin{solutionbox}
\textbf{Answer}: In ``Leopard,'' the author's search for the forktail's
nest demonstrates his passion for wildlife observation.

\textbf{Table: The Forktail Nest Search}
...
\textbf{Mnemonic:} ``Watch, Follow, Discover''
...
\begin{solutionbox}
\textbf{Answer}: The 7 Cs framework ensures effective business
communication through essential principles.

\textbf{Table: The 7 Cs of Business Communication}
...
\textbf{Mnemonic:} ``Clear, Concise, Complete Communication Creates
Correct Connection''
...
marks{]}}\label{alternative-question-5a-3-marks}
...
\begin{solutionbox}
  \_\_\_\_\_\_\_\_\_\_\_\_. \textbf{Answer}: (a) Salutation
\end{solutionbox}
\item
...
\begin{solutionbox}
  \_\_\_\_\_\_\_\_\_\_. \textbf{Answer}: (d) Complaint Letter
\end{solutionbox}
\item
  \_\_\_\_\_\_\_\_ refers to any additional documents that you've
\begin{solutionbox}
  attached to your letter. \textbf{Answer}: (c) Enclosure
\end{solutionbox}
\end{enumerate}

\subsection{Alternative Question 5(b) {[}4
marks{]}}\label{alternative-question-5b-4-marks}
...
\begin{solutionbox}
\textbf{Answer}: A business letter follows a structured format with
specific components arranged in a standard order.

\textbf{Table: Parts of a Business Letter}
...
marks{]}}\label{alternative-question-5c-7-marks}
