...
\textbf{ધાતુના સળિયાની લંબાઈ 12^\circC તાપમાને 64.522 cm છે અને 90^\circC તાપમાને 64.576
cm છે. તો સળિયાના રેખીય વિસ્તરણ ગુણાંક શોધો.}

\begin{solutionbox}
\textbf{સૂત્ર:} α = (L_{2} - L_{1})/[L_{1} \times (T_{2} - T_{1})]
...
\tightlist
\item
  પ્રારંભિક લંબાઈ (L_{1}) = 64.522 cm
\item
  અંતિમ લંબાઈ (L_{2}) = 64.576 cm
\item
  પ્રારંભિક તાપમાન (T_{1}) = 12^\circC
\item
  અંતિમ તાપમાન (T_{2}) = 90^\circC
\end{itemize}
...
\item
  \textbf{વાંચન પ્રક્રિયા}: મુખ્ય સ્કેલ વાંચન + (મેળ ખાતા વર્નિયર વિભાગ \times લઘુત્તમ
  માપ)
\item
...
\item
  \textbf{વાંચન}: મુખ્ય સ્કેલ વાંચન + (ગોળાકાર સ્કેલ વાંચન \times લઘુત્તમ માપ)
\item
...
\begin{solutionbox}
\textbf{સૂત્ર:} વ્યાસ = મુખ્ય સ્કેલ વાંચન + (ગોળાકાર સ્કેલ વાંચન \times
લઘુત્તમ માપ)
...
વ્યાસ = 7 + (65 \times 0.01) = 7 + 0.65 = 7.65 mm

\end{solutionbox}
\begin{mnemonicbox}
``MSR + (CSR \times LC) આપે છે અંતિમ માપણી''
...
\bottomrule\noalign{}
\endlastfoot
0^\circ અથવા 360^\circ & રચનાત્મક & મહત્તમ કંપવિસ્તાર \\
180^\circ & વિનાશક & લઘુત્તમ કંપવિસ્તાર \\
\end{longtable}
...
\textbf{સમાંતર પ્લેટ કેપેસિટર:} કેપેસીટન્સ સૂત્ર: C = ε_{0}A/d

\begin{itemize}
\tightlist
\item
  ε_{0} = મુક્ત અવકાશની પરાવૈદ્યુતાંક
\item
...
\textbf{જો કોઈ બે નળાકારની લંબાઈ (6.52\pm0.01) cm અને (4.48\pm0.02) cm છે. તો
...
\tightlist
\item
  પ્રથમ નળાકારની લંબાઈ (L_{1}) = 6.52 \pm 0.01 cm
\item
  બીજા નળાકારની લંબાઈ (L_{2}) = 4.48 \pm 0.02 cm
\item
  લંબાઈનો તફાવત (ΔL) = L_{1} - L_{2} = 6.52 - 4.48 = 2.04 cm
\end{itemize}

\textbf{તફાવતમાં નિરપેક્ષ ત્રુટિ} = \sqrt[(0.01)^{2} + (0.02)^{2}] = \sqrt(0.0001 +
0.0004) = \sqrt0.0005 = 0.022 cm

\textbf{પ્રતિશત ત્રુટિ} = (નિરપેક્ષ ત્રુટિ/માપેલી કિંમત) \times 100 = (0.022/2.04) \times
100 = 1.08\%
...
\bottomrule\noalign{}
\endlastfoot
રચનાત્મક & 0^\circ, 360^\circ, 720^\circ\ldots{} & પ્રબલીકરણ & મહત્તમ \\
વિનાશક & 180^\circ, 540^\circ, 900^\circ\ldots{} & રદ્દીકરણ & ન્યૂનતમ \\
\end{longtable}
...
\item
  ...
  દીઠ કરેલું કાર્ય
\item
  \textbf{સમીકરણ}: V = W/q_{0} = \int(F·dr)
\end{itemize}
...
\tightlist
\item
  ચાર્જો વચ્ચેનું બળ (કુલોમ્બનો નિયમ): F = (1/4πε_{0}) \times (Qq/r^{2})
\item
  પરીક્ષણ ચાર્જ ખસેડવામાં કરેલું કાર્ય: W = \int(F·dr)
\item
  ત્રિજ્યા ગતિ માટે: W = (Q/4πε_{0}) \times \int(1/r^{2})dr, \infty થી r સુધી
\item
  સંકલન: W = (Q/4πε_{0}) \times [-1/r]ᵣ\infty
\item
અંતિમ પરિણામ:
...
\textbf{અંતિમ સૂત્ર:} V = (1/4πε_{0}) \times (Q/r)
...
\item
  અંતર (d) = કંપનોની સંખ્યા (n) \times તરંગલંબાઈ (λ)
\end{itemize}
...
\item
  q = ખસેડાતો ચાર્જ
\item
  V_{a} = પ્રારંભિક સ્થિતિનું પોટેન્શિયલ
\item
...
\end{solutionbox}
\begin{mnemonicbox}
``PEW: પોટેન્શિયલ તફાવત \times વિદ્યુત ચાર્જ = કાર્ય''
...
\item
  ઉચ્ચ ચોકસાઈ
\item
  વિશાળ તાપમાન શ્રેણી (-38^\circC થી 357^\circC)
\item
...
\item
  નાજુક કાચની રચના
\item
  -38^\circC નીચે વાપરી શકાતું નથી
\item
...
\textbf{સરખા માપના બે ધનઆયનને 5\times10^{-}^{1}^{0} m અંતરથી અલગ રાખવામા આવ્યા છે. તેમના વચ્ચે
લાગતું વિદ્યુત બળ 3.7 \times 10^{-}^{9} N જેટલું છે. તો દરેક એટમ માથી કેટલા ઇલેક્ટ્રોન નીકળશે.}

\begin{solutionbox}
\textbf{સૂત્ર:} F = (1/4πε_{0}) \times (q_{1}q_{2}/r^{2})
...
\item
  r = 5 \times 10^{-}^{1}^{0} m
\item
q_{1} = q_{2} = ne (n = ઇલેક્ટ્રોનની સંખ્યા,
...
(n^{2} \times (1.6 \times 10^{-}^{1}^{9})^{2}/25 \times 10^{-}^{2}^{0}) ઉકેલ: n = 1 (દરેક પરમાણુમાંથી 1 ઇલેક્ટ્રોન
નીકળ્યો)
...
\textbf{સૂત્ર:} (sin i)/(sin r) = n_{2}/n_{1} = અચળાંક
...
\item
  અંતિમ સૂત્ર: n_{1}sin i = n_{2}sin r
\end{enumerate}
...
\begin{solutionbox}
\textbf{સમાંતર જોડાણ:} C_{p} = C_{1} + C_{2} + C_{3} = 5 + 10 + 15 =
30 µF

\textbf{શ્રેણી જોડાણ:} 1/C_{s} = 1/C_{1} + 1/C_{2} + 1/C_{3} 1/C_{s} = 1/5 + 1/10 + 1/15
1/C_{s} = 0.2 + 0.1 + 0.067 = 0.367 C_{s} = 1/0.367 = 2.72 µF
...
\tightlist
\item
  ન્યુમેરિકલ એપર્ચર (NA) = \sqrt(n_{1}^{2} - n_{2}^{2})
\item
  સ્વીકૃતિ કોણ (θ_{a}) = sin^{-}^{1}(NA)
\end{itemize}
...
\tightlist
\item
  કોર વક્રીભવનાંક (n_{1}) = 1.55
\item
  ક્લેડિંગ વક્રીભવનાંક (n_{2}) = 1.5
\end{itemize}

NA = \sqrt(1.55^{2} - 1.5^{2}) NA = \sqrt(2.4025 - 2.25) NA = \sqrt0.1525 NA = 0.391

સ્વીકૃતિ કોણ (θ_{a}) = sin^{-}^{1}(0.391) θ_{a} = 23.03^\circ
...
(અથવા 1^\circC) વધારવા માટે જરૂરી ઉષ્મા.
...
\textbf{એકમો:} J/kg·K અથવા J/kg·^\circC
...
\item
  સ્વીકૃતિ કોણ (θ_{a}) = sin^{-}^{1}(NA)
\item
  ક્રાંતિક કોણ (θc) = sin^{-}^{1}(n_{2}/n_{1})
\end{itemize}
...
\tightlist
\item
  કોર વક્રીભવનાંક (n_{1}) = 1.48
\item
  ક્લેડિંગ વક્રીભવનાંક (n_{2}) = 1.45
\end{itemize}

NA = \sqrt(1.48^{2} - 1.45^{2}) NA = \sqrt(2.1904 - 2.1025) NA = \sqrt0.0879 NA = 0.296

સ્વીકૃતિ કોણ (θ_{a}) = sin^{-}^{1}(0.296) θ_{a} = 17.2^\circ

ક્રાંતિક કોણ (θc) = sin^{-}^{1}(n_{2}/n_{1}) θc = sin^{-}^{1}(1.45/1.48) θc = sin^{-}^{1}(0.9797)
θc = 78.4^\circ
