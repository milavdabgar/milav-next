...
મુખ્ય સ્કેલ પર 1 વિભાગ \div વર્નિયર સ્કેલ પર વિભાગોની સંખ્યા
...
\textbf{સૂત્ર}: લઘુત્તમ માપ શક્તિ = પિચ \div વર્તુળાકાર સ્કેલ પર વિભાગોની સંખ્યા

\textbf{ગણતરી}: LC = 0.5 mm \div 50 = 0.01 mm
...
\item
  ...
  \item
    સરેરાશ નિરપેક્ષ ત્રુટિ: Δa = (Δa1 + Δa2 + \ldots{} + Δan) \div n
  \end{enumerate}
\end{itemize}
...
\tightlist
\item
  εr = નિરપેક્ષ ત્રુટિ \div સાચું મૂલ્ય = Δa \div સાચું મૂલ્ય
\end{itemize}
...
\tightlist
\item
  εp = સાપેક્ષ ત્રુટિ \times 100 = (Δa \div સાચું મૂલ્ય) \times 100\%
\end{itemize}
...
\textbf{સૂત્ર}: લઘુત્તમ માપ શક્તિ = મુખ્ય સ્કેલ પર 1 વિભાગ \div વર્નિયર સ્કેલ પર
વિભાગોની સંખ્યા

\textbf{ગણતરી}: મુખ્ય સ્કેલ પર 1 વિભાગ = 1 mm LC = 1 mm \div 50 = 0.02 mm
...
\textbf{ગણિતીય સ્વરૂપ}: F = k(q_{1}q_{2})/r^{2}
...
\item
  k = ઇલેક્ટ્રોસ્ટેટિક અચળાંક (9\times10^{9} N·m^{2}/C^{2})
\item
  q_{1}, q_{2} = ચાર્જના જથ્થા (કુલંબમાં)
\item
...
દરેક કેપેસિટર માટે: V_{1} = Q/C_{1}, V_{2} = Q/C_{2}, V_{3} = Q/C_{3}
...
તેથી: 1/Ceq = 1/C_{1} + 1/C_{2} + 1/C_{3}
...
દરેક કેપેસિટર માટે: Q_{1} = C_{1}V, Q_{2} = C_{2}V, Q_{3} = C_{3}V
...
\textbf{સમાંતર સંયોજન માટે સૂત્ર}: Ceq = C_{1} + C_{2}
...
નિર્ભરતા & 1/r^{2} સાથે બદલાય & 1/r સાથે બદલાય \\
...
\textbf{સમાંતર પ્લેટ કેપેસિટરના કેપેસિટન્સનું સૂત્ર}: C = ε_{0}εᵣA/d
...
\item
  C = કેપેસિટન્સ
\item
  ε_{0} = નિર્વાત અવકાશની પરમિટિવિટી (8.85\times10^{-}^{1}^{2} F/m)
\item
...
\item
  ક્ષેત્રફળ વધારતાં \rightarrow કેપેસિટન્સ વધે છે
\item
  ક્ષેત્રફળ બમણો કરતાં \rightarrow કેપેસિટન્સ બમણું થાય છે
\end{itemize}
...
\item
  અંતર વધારતાં \rightarrow કેપેસિટન્સ ઘટે છે
\item
  અંતર બમણું કરતાં \rightarrow કેપેસિટન્સ અડધું થાય છે
\end{itemize}
...
\item
  ડાઇલેક્ટ્રિક દાખલ કરતાં \rightarrow કેપેસિટન્સ વધે છે
\item
  ડાઇલેક્ટ્રિક અચળાંક આ વધારાનું માપ કરે છે: C(ડાઇલેક્ટ્રિક સાથે) = εᵣ \times C(ડાઇલેક્ટ્રિક
  વગર)
\end{itemize}
...
\tightlist
\item
  કેપેસિટન્સ (C) = 0.5 μF = 0.5 \times 10^{-}^{6} F
\item
  વોલ્ટેજ (V) = 150 V
\end{itemize}

\textbf{ગણતરી}: Q = CV = 0.5 \times 10^{-}^{6} \times 150 = 75 \times 10^{-}^{6} C = 75 μC
...
\textbf{તાપમાન શ્રેણી}: -38.83^\circC થી 356.73^\circC (પારાના ઠારણ બિંદુથી ઉત્કલન બિંદુ)
...
ફૂરિયરના નિયમ અનુસાર: Q ∝ A \times t \times ΔT/L

પ્રમાણસરતા અચળાંક K સાથે સમીકરણમાં રૂપાંતરિત કરતાં: Q = K \times A \times t \times ΔT/L

ફરીથી ગોઠવતાં: K = (Q \times L)/(A \times t \times ΔT)
...
\textbf{એક કાચની વિંડોનું કુલ ક્ષેત્રફળ 0.5m^{2} છે. જો કાચની જાડાઈ 0.6cm, અંદરનું
તાપમાન 30^\circC અને બહારનું તાપમાન 20^\circC છે તો વિંડો દ્વારા પ્રતિ કલાક થતી ઉષ્માનું
વહનનું ગણતરી કરો. કાચ માટે ઉષ્માવાહકતા અંક 1.0 Wm^{-}^{1}K^{-}^{1} છે.}

\begin{solutionbox}

\textbf{સૂત્ર}: Q = (K \times A \times t \times ΔT)/L
...
\item
  અંદરનું તાપમાન (T_{1}) = 30^\circC
\item
  બહારનું તાપમાન (T_{2}) = 20^\circC
\item
  તાપમાન તફાવત (ΔT) = 10^\circC = 10 K
\item
...
\textbf{ગણતરી}: Q = (1.0 \times 0.5 \times 3600 \times 10)/0.006 Q = (18000)/0.006 Q =
3,000,000 J = 3000 kJ
...
\tightlist
\item
  કોઈ પદાર્થના તાપમાનમાં 1^\circC અથવા 1K વધારવા માટે જરૂરી ઉષ્મા ઊર્જાનો જથ્થો
\item
...
\tightlist
\item
  કોઈ પદાર્થના 1 kg ના તાપમાનમાં 1^\circC અથવા 1K વધારવા માટે જરૂરી ઉષ્મા ઊર્જાનો
  જથ્થો
\item
...
\textbf{સંબંધ}: ઉષ્માધારિતા (C) = દ્રવ્યમાન (m) \times વિશિષ્ટ ઉષ્મા (c)
...
\textbf{તાપમાન શ્રેણી}: 700^\circC થી 3000^\circC
...
\tightlist
\item
  લંબાઈમાં ફેરફાર (ΔL) મૂળ લંબાઈ (L_{0}) સાથે સીધો પ્રમાણસર છે
\item
  ΔL તાપમાન ફેરફાર (ΔT) સાથે સીધો પ્રમાણસર છે
\end{itemize}

તેથી: ΔL ∝ L_{0} \times ΔT

પ્રમાણસરતા અચળાંક α સાથે સમીકરણમાં રૂપાંતરિત કરતાં: ΔL = α \times L_{0} \times ΔT

ફરીથી ગોઠવતાં: α = ΔL/(L_{0} \times ΔT)
...
\item
  L_{0} = મૂળ લંબાઈ (મીટરમાં)
\item
  ΔT = તાપમાન ફેરફાર (કેલ્વિન અથવા સેલ્સિયસમાં)
\item
  α = રેખીય ઉષ્મીય વિસ્તરણ ગુણાંક (પ્રતિ ^\circC અથવા પ્રતિ K)
\end{itemize}

\textbf{અંતિમ લંબાઈ}: L = L_{0}(1 + αΔT)
...
\textbf{0^\circC પર સ્ટીલના સળિયાની લંબાઈ 150 cm છે. 200^\circC પર તેની લંબાઈ કેટલી હશે
જો તેનો રેખીય ઉષ્મીય વિસ્તરણનો ગુણાંક 12 \times 10^{-}^{6} પ્રતિ ^\circC હો}

\begin{solutionbox}

\textbf{સૂત્ર}: L = L_{0}(1 + αΔT)
...
\tightlist
\item
  મૂળ લંબાઈ (L_{0}) = 150 cm
\item
  મૂળ તાપમાન = 0^\circC
\item
  અંતિમ તાપમાન = 200^\circC
\item
  તાપમાન ફેરફાર (ΔT) = 200^\circC
\item
  રેખીય ઉષ્મીય વિસ્તરણ ગુણાંક (α) = 12 \times 10^{-}^{6} પ્રતિ ^\circC
\end{itemize}

\textbf{ગણતરી}: L = 150(1 + 12 \times 10^{-}^{6} \times 200) L = 150(1 + 24 \times 10^{-}^{4}) L =
150(1 + 0.0024)
...
\item
  સંપૂર્ણ ચક્ર = 2π રેડિયન અથવા 360^\circ
\item
  એક જ કલા ધરાવતા બિંદુઓ એકસરખા કલામાં છે
\item
  π રેડિયન (180^\circ) થી અલગ હોય તે બિંદુઓ વિરુદ્ધ કલામાં છે
\end{itemize}
...
\item
  કલા તફાવત = 0, 2π, 4π, \ldots{} (0^\circ, 360^\circ, 720^\circ, \ldots)
\item
...
\item
  કલા તફાવત = π, 3π, 5π, \ldots{} (180^\circ, 540^\circ, 900^\circ, \ldots)
\item
...
\item
  સ્નેલના નિયમને અનુસરે છે: n_{1}sin(θ_{1}) = n_{2}sin(θ_{2})
\item
...
\tightlist
\item
  \textbf{વ્યાખ્યા}: પ્રમાણમાં લાંબા જીવનકાળ (10^{-}^{3} થી 10^{-}^{7} સેકન્ડ) વાળી ઉત્તેજિત
  ઊર્જા અવસ્થા
\item
  \textbf{મહત્વ}:
...
\begin{verbatim}
          |
  E_{3} ----|---- ટૂંકા-જીવનકાળ વાળી ઉત્તેજિત અવસ્થા
          |
          v ઝડપી સંક્રમણ (નોન-રેડિયેટિવ)
          |
  E_{2} ----|---- મેટાસ્ટેબલ સ્ટેટ (લાંબો જીવનકાળ)
          |
...
\item
  \textbf{રીફ્રેક્ટિવ ઈન્ડેક્સ પ્રોફાઈલ}: પરવલયિક પેટર્નને અનુસરે છે: n(r) = n_{1}(1 -
  αr^{2})
\item
...
\item
  ...
  હોય છે
\item
  સૂત્ર: n_{1}sin(θ_{1}) = n_{2}sin(θ_{2})
\item
  જ્યાં:
  ...
  \tightlist
  \item
    n_{1} = પ્રથમ માધ્યમનો રીફ્રેક્ટિવ ઈન્ડેક્સ
  \item
    n_{2} = બીજા માધ્યમનો રીફ્રેક્ટિવ ઈન્ડેક્સ
  \item
    θ_{1} = આપાત કોણ
  \item
    θ_{2} = વક્રીભવન કોણ
...
\end{solutionbox}
\begin{mnemonicbox}
``સાઇન ગુણોત્તર ઈન્ડેક્સ ગુણોત્તર સાથે સમાન'' અથવા ``n_{1}Sin_{1}
= n_{2}Sin_{2}''
...
\item
  sin(θc) = n_{2}/n_{1} (જ્યાં n_{1} = કોર ઈન્ડેક્સ, n_{2} = ક્લેડિંગ ઈન્ડેક્સ)
\end{itemize}
...
\item
  કોરમાં મહત્તમ ખૂણો: 90^\circ - θc
\end{itemize}

\textbf{સ્ટેપ 3}: હવામાંથી (n_{0} = 1) દાખલ થતા કિરણ માટે, સ્નેલનો નિયમ લાગુ કરો
...
\item
  જ્યાં θ_{a} એસેપટન્સ એંગલ છે
\end{itemize}

\textbf{સ્ટેપ 4}: θ_{1} નું મહત્તમ મૂલ્ય (90^\circ - θc) વાપરો
...
\textbf{સ્ટેપ 5}: sin(θc) = n_{2}/n_{1} પ્રતિસ્થાપિત કરો
...
\tightlist
\item
  ન્યુમરિકલ એપર્ચર (NA) = sin(θ_{a}) = \sqrt(n_{1}^{2} - n_{2}^{2})
\item
  જ્યાં θ_{a} એસેપટન્સ એંગલ છે
\end{itemize}
...
\end{solutionbox}
\begin{mnemonicbox}
``NA એસેપટન્સ એંગલ સૂચવે; \sqrt(n_{1}^{2} - n_{2}^{2}) મહત્તમ સાઇન દર્શાવે''
