...
caliper. LC = 1 division on main scale ÷ Number of divisions on vernier
scale
...
\end{mnemonicbox}
\subsection*{Question 1(c)(i) {[}4 marks{]}}\label{question-1ci-4-marks}
...
marks{]}}\label{question-1cii-2-marks}
...
\textbf{Formula}: Least Count = Pitch ÷ Number of divisions on circular
scale

\textbf{Calculation}: LC = 0.5 mm ÷ 50 = 0.01 mm

\textbf{Least Count of micrometer screw gauge = 0.01 mm}

\end{solutionbox}
\subsection*{Question 1(c)(iii) {[}1
mark{]}}\label{question-1ciii-1-mark}
...
(OR)}\label{question-1ci-4-marks-or}
...
\item
  ...
  \item
    Mean absolute error: Δa = (Δa1 + Δa2 + \ldots{} + Δan) ÷ n
  \end{enumerate}
\end{itemize}
...
(OR)}\label{question-1cii-2-marks-or}
...
\textbf{Formula}: Least Count = 1 division on main scale ÷ Number of
divisions on vernier scale

\textbf{Calculation}: 1 division on main scale = 1 mm LC = 1 mm ÷ 50 =
0.02 mm
...
(OR)}\label{question-1ciii-1-mark-or}
...
\textbf{Mathematical Form}: F = k(q₁q₂)/r²
...
\end{mnemonicbox}
\subsection*{Question 2(c)(i) {[}4 marks{]}}\label{question-2ci-4-marks}
...
marks{]}}\label{question-2cii-2-marks}
...
\textbf{Formula for parallel combination}: Ceq = C₁ + C₂
...
mark{]}}\label{question-2ciii-1-mark}
...
(OR)}\label{question-2a-3-marks-or}
...
(OR)}\label{question-2b-4-marks-or}
...
(OR)}\label{question-2ci-4-marks-or}
...
\item
  Dielectric constant measures this increase: C(with dielectric) = εᵣ ×
...
(OR)}\label{question-2cii-2-marks-or}
...
\textbf{Calculation}: Q = CV = 0.5 × 10⁻⁶ × 150 = 75 × 10⁻⁶ C = 75 μC

\textbf{Therefore, charge on plates = 75 μC}

\end{solutionbox}
\subsection*{Question 2(c)(iii) {[}1 mark{]}
(OR)}\label{question-2ciii-1-mark-or}
...
\textbf{Temperature Range}: -38.83°C to 356.73°C (mercury's freezing to
boiling point)
...
\end{mnemonicbox}
\subsection*{Question 3(c)(i) {[}4 marks{]}}\label{question-3ci-4-marks}
...
Converting to equation with proportionality constant K: Q = K × A × t ×
ΔT/L
...
marks{]}}\label{question-3cii-2-marks}

\textbf{The total area of glass window pane is 0.5m². Calculate amount
of heat conducted per hour through the pane if thickness of glass is
0.6cm, the inside temperature is 30°C and outside temperature is 20°C.
Coefficient of thermal conductivity of glass is 1.0 Wm⁻¹K⁻¹.}

\begin{solutionbox}

\textbf{Formula}: Q = (K × A × t × ΔT)/L
...
\textbf{Calculation}: Q = (1.0 × 0.5 × 3600 × 10)/0.006 Q =
(18000)/0.006 Q = 3,000,000 J = 3000 kJ

\textbf{Therefore, heat conducted = 3000 kJ per hour}

\end{solutionbox}
\subsection*{Question 3(c)(iii) {[}1
mark{]}}\label{question-3ciii-1-mark}
...
(OR)}\label{question-3a-3-marks-or}
...
\textbf{Relation}: Heat capacity (C) = mass (m) × specific heat (c)
...
(OR)}\label{question-3b-4-marks-or}
...
\textbf{Temperature Range}: 700°C to 3000°C
...
(OR)}\label{question-3ci-4-marks-or}
...
(OR)}\label{question-3cii-2-marks-or}

\textbf{Length of a steel rod at 0°C is 150 cm. What will be its length
at 200°C, if its coefficient of linear thermal expansion is 12 × 10⁻⁶
per °C.}

\begin{solutionbox}

\textbf{Formula}: L = L₀(1 + αΔT)
...
\textbf{Calculation}: L = 150(1 + 12 × 10⁻⁶ × 200) L = 150(1 + 24 ×
10⁻⁴) L = 150(1 + 0.0024) L = 150 × 1.0024 L = 150.36 cm

\textbf{Therefore, final length of steel rod = 150.36 cm}

\end{solutionbox}
\subsection*{Question 3(c)(iii) {[}1 mark{]}
(OR)}\label{question-3ciii-1-mark-or}
...
\end{mnemonicbox}
\subsection*{Question 4(c)(i) {[}5 marks{]}}\label{question-4ci-5-marks}
...
marks{]}}\label{question-4cii-2-marks}
...
(OR)}\label{question-4a-3-marks-or}
...
(OR)}\label{question-4b-4-marks-or}
...
\item
  Phase difference = 0, 2π, 4π, \ldots{} (0°, 360°, 720°, \ldots)
\item
...
\item
  Phase difference = π, 3π, 5π, \ldots{} (180°, 540°, 900°, \ldots)
\item
...
(OR)}\label{question-4ci-5-marks-or}
...
(OR)}\label{question-4cii-2-marks-or}
...
\end{mnemonicbox}
\subsection*{Question 5(c)(i) {[}5 marks{]}}\label{question-5ci-5-marks}
...
marks{]}}\label{question-5cii-2-marks}
...
(OR)}\label{question-5a-3-marks-or}
...
\end{solutionbox}
\begin{mnemonicbox}
``Sine ratios Equal Index ratios'' or ``n₁Sin₁ =
n₂Sin₂''

\end{mnemonicbox}
\subsection*{Question 5(b) {[}4 marks{]}
(OR)}\label{question-5b-4-marks-or}
...
(OR)}\label{question-5ci-5-marks-or}
...
\textbf{Step 3}: For ray entering from air (n₀ = 1), apply Snell's law
...
\textbf{Step 4}: Use maximum value of θ₁ (90° - θc)
...
\textbf{Step 5}: Substitute sin(θc) = n₂/n₁
...
\end{solutionbox}
\begin{mnemonicbox}
``NA Notes Acceptance angle; √(n₁² - n₂²) Shows
maximum sine''

\end{mnemonicbox}
\subsection*{Question 5(c)(ii) {[}2 marks{]}
(OR)}\label{question-5cii-2-marks-or}
