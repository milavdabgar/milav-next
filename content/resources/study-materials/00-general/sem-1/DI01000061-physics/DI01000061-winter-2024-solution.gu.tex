...
\textbf{જ્યારે 4 µF કેપેસિટન્સ ધરાવતા કેપેસિટરને 12 volt બેટરી સાથે જોડતા કેપેસિટરની બંને પ્લેટ પર સંગ્રહિત થતાં વિદ્યુતભારના જથ્થાની ગણતરી કરો.}

\begin{solutionbox}
\textbf{આપેલ:}
\begin{align*}
\text{કેપેસિટન્સ } (C) &= 4\text{ µF} = 4 \times 10^{-6}\text{ F}\\
...
\textbf{જવાબ: સંગ્રહિત વિદ્યુતભાર = 48 µC}
\end{solutionbox}
