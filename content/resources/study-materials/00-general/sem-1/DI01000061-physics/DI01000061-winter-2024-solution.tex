...
% Forward characteristic - exponential curve (reduced height)
\draw[thick,blue,domain=0:1.2,samples=40] plot (\x,{0.08*exp(4*\x)-0.08});
...
\node[blue] at (0.8,1.2) {\scriptsize Forward};
