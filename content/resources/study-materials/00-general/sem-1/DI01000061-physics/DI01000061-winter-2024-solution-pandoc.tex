...
\textbf{Prove C = \epsilon_{0}A/d for parallel plate capacitor.}
...
\tightlist
\item
  \textbf{Electric field} between plates: E = \sigma/\epsilon_{0} = Q/(\epsilon_{0}A)
\item
  \textbf{Potential difference}: V = E \times d = Qd/(\epsilon_{0}A)
\item
  \textbf{Capacitance definition}: C = Q/V
\item
  \textbf{Substituting}: C = Q \div [Qd/(\epsilon_{0}A)] = \epsilon_{0}A/d
\end{itemize}

\textbf{Final Formula}: \textbf{C = \epsilon_{0}A/d}
...
\tightlist
\item
  \textbf{\epsilon_{0}}: Permittivity of free space
\item
...
\textbf{Snell's Law}: n_{1} sin \theta_{1} = n_{2} sin \theta_{2}
...
\item
  \textbf{\theta_{1}, \theta_{2}}: Angles of incidence and refraction
\end{itemize}
