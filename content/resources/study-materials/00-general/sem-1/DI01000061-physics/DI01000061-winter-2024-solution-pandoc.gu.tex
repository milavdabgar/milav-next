...
\textbf{જ્યારે 4 μF કેપેસિટન્સ ધરાવતા કેપેસિટરને 12 volt બેટરી સાથે જોડતા કેપેસિટરની
...
\bottomrule\noalign{}
\endlastfoot
વિદ્યુત ફ્લક્સ & સપાટીમાંથી પસાર થતી વિદ્યુત ક્ષેત્ર રેખાઓની સંખ્યા & Nm^{2}/C & Φ =
E·A \\
...
\textbf{સમાંતર પ્લેટ કેપેસિટર માટે C = ε_{0}A/d સાબિત કરો.}
...
\tightlist
\item
  \textbf{પ્લેટો વચ્ચે વિદ્યુત ક્ષેત્ર}: E = σ/ε_{0} = Q/(ε_{0}A)
\item
  \textbf{વીજસ્થિતિમાનનો તફાવત}: V = E \times d = Qd/(ε_{0}A)
\item
  \textbf{કેપેસિટન્સની વ્યાખ્યા}: C = Q/V
\item
  \textbf{બદલીને}: C = Q \div [Qd/(ε_{0}A)] = ε_{0}A/d
\end{itemize}

\textbf{અંતિમ સૂત્ર}: \textbf{C = ε_{0}A/d}
...
\tightlist
\item
  \textbf{ε_{0}}: મુક્ત અવકાશની વિદ્યુત પ્રવેશ્યતા
\item
...
\textbf{સ્નેલનો નિયમ}: n_{1} sin θ_{1} = n_{2} sin θ_{2}
...
\item
  \textbf{θ_{1}, θ_{2}}: આપાત અને વક્રીભવન કોણ
\end{itemize}
