...
\begin{center}
{\Huge\bfseries\color{headcolor} Engineering Chemistry Solutions}\\[5pt]
...
\begin{mnemonicbox}
"Chemical Copper Creates Beautiful Properties" (for remembering key concepts)
\end{mnemonicbox}
...
\begin{mnemonicbox}
"Sodium Loses, Chlorine Gains, Attraction Forms" (SLCGAF)
\end{mnemonicbox}
...
\begin{mnemonicbox}
"LASRE = Lead Acid Storage Reversible Energy"
\end{mnemonicbox}
