...
\end{solutionbox}
\begin{mnemonicbox}
``ફ્લક્સ ચેન્જ જનરેટ્સ EMF'' (d\Phi/dt = EMF)
...
\bottomrule\noalign{}
\endlastfoot
\textbf{KVL} & બંધ લૂપમાં વોલ્ટેજનો સરવાળો = 0 & \SigmaV = 0 & સિરીઝ સર્કિટ \\
\textbf{KCL} & નોડ પર કરંટનો સરવાળો = 0 & \SigmaI = 0 & પેરેલલ સર્કિટ \\
\end{longtable}
...
\textbf{સૂત્ર} & e = -N(d\Phi/dt) & e = BLv \\
...
\item
  \textbf{\Phi_{m}}: મેક્સિમમ ફ્લક્સ, \textbf{f}: ફ્રિક્વન્સી
\end{itemize}
...
\textbf{\Phi_{m}} & મેક્સિમમ ફ્લક્સ & વેબર \\
...
\tightlist
\item
  \textbf{આર્મેચર કન્ટ્રોલ}: N ∝ (V - IaRa)/\phi
\item
  \textbf{ફીલ્ડ કન્ટ્રોલ}: N ∝ V/\phi
\item
  \textbf{રેઝિસ્ટન્સ કન્ટ્રોલ}: N ∝ (V - Ia(Ra + Rext))/\phi
\end{itemize}
...
\textbf{એંગ્યુલર વેલોસિટી} & \omega & rad/s & રોટેશન સ્પીડ \\
\textbf{ફેઝ એંગલ} & \phi & ડિગ્રી & પ્રારંભિક ફેઝ \\
\textbf{ફ્રિક્વન્સી} & f = \omega/2\pi & Hz & સાઇકલ પર સેકન્ડ \\
\end{longtable}
...
\textbf{એવરેજ વેલ્યુ} & અર્ધ સાઇકલ પર સરેરાશ મૂલ્ય & 2Im/\pi & એમ્પિયર \\
...
\tightlist
\item
  \textbf{ફોર્મ ફેક્ટર}: RMS/Average = \pi/2\sqrt2 = 1.11
\item
  \textbf{પીક ફેક્ટર}: Peak/RMS = \sqrt2 = 1.414
\item
  \textbf{એંગ્યુલર ફ્રિક્વન્સી}: \omega = 2\pif
\end{itemize}
...
\textbf{પાવર} & P = \sqrt3 \times VL \times IL \times cos\phi \\
\end{longtable}
...
\textbf{ફેઝ} & \phi & લીડિંગ/લેગિંગ એંગલ \\
\textbf{એંગ્યુલર વેલોસિટી} & \omega & રોટેશન સ્પીડ \\
...
\textbf{એંગ્યુલર વેલોસિટી} & ફેઝ ચેન્જનો દર & \omega = 2\pif & 314 rad/s (50Hz) \\
...
\textbf{ફેઝ એંગલ} & V અને I વચ્ચેનો કોણ & \phi = tan^{-}^{1}(X/R) & ડિગ્રી \\
\textbf{પાવર ફેક્ટર} & ફેઝ એંગલનો કોસાઇન & PF = cos\phi = R/Z & - \\
\textbf{રિએક્ટિવ પાવર} & રિએક્ટિવ કોમ્પોનન્ટમાં પાવર & Q = VI sin\phi & VAR \\
\end{longtable}
...
\tightlist
\item
  \textbf{એક્ટિવ પાવર}: P = VI cos\phi (વોટ)
\item
  \textbf{રિએક્ટિવ પાવર}: Q = VI sin\phi (VAR)
\item
...
\textbf{આપેલ:} L ઇન્ડક્ટન્સ સાથે શુદ્ધ ઇન્ડક્ટર, લાગુ વોલ્ટેજ v = Vm sin(\omegat)
...
\bottomrule\noalign{}
\endlastfoot
\textbf{કરંટ એમ્પ્લિટ્યૂડ} & Im = Vm/\omegaL & કરંટ વોલ્ટેજથી 90^\circ પાછળ \\
\textbf{ઇન્ડક્ટિવ રિએક્ટન્સ} & XL = \omegaL = 2\pifL & ફ્રિક્વન્સી આધારિત \\
...
\bottomrule\noalign{}
\endlastfoot
\textbf{એક્ટિવ પાવર} & P & VI cos\phi & વોટ & ઉપયોગી પાવર \\
\textbf{રિએક્ટિવ પાવર} & Q & VI sin\phi & VAR & પરિભ્રમણ પાવર \\
