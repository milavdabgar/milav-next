...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-6ccd5186.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-b417fbcc.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-dbe63806.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-7624b3aa.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-1e5eb643.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-01f20b02.pdf}
...
\passthrough{\lstinline!GRANT SELECT ON table TO user!} \\
\textbf{REVOKE} & Removes privileges from users &
\passthrough{\lstinline!REVOKE SELECT ON table FROM user!} \\
\end{longtable}
}
...
\passthrough{\lstinline!INSTR(string, substring)!} &
\passthrough{\lstinline!INSTR('Hello', 'e')!} returns 2 \\
\textbf{LENGTH} & Returns string length &
\passthrough{\lstinline!LENGTH(string)!} &
\passthrough{\lstinline!LENGTH('Hello')!} returns 5 \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{MAX} & Returns maximum value &
\passthrough{\lstinline!MAX(column)!} &
\passthrough{\lstinline!MAX(salary)!} \\
\textbf{SUM} & Returns total sum & \passthrough{\lstinline!SUM(column)!}
& \passthrough{\lstinline!SUM(marks)!} \\
\end{longtable}
}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-fcd43d93.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-c4a73103.pdf}
