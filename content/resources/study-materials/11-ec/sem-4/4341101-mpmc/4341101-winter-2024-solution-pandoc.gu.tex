...
\textbf{માઇક્રોકંટ્રોલર્સનાં સામાન્ય ફીચર્સની સૂચિ બનાવો.}
...
\textbf{યાદ રાખવા માટે:} ``ALFS: અરિથમેટિક લોજિક ફ્લેગ સ્ટેટસ''

\end{solutionbox}
\subsection*{પ્રશ્ન 1(ક) [7
ગુણ]}\label{uxaaauxab0uxab6uxaa8-1uxa95-7-uxa97uxaa3}

\textbf{વ્યાખ્યાયિત કરો: મેમરી, ઓપરેન્ડ, ઈન્સ્ટ્રક્શન સાયકલ, ઓપકોડ, CU, મશીન
સાયકલ, CISC}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{મેમરી} & ડેટા અને સૂચનાઓ સંગ્રહિત કરતું સ્ટોરેજ યુનિટ \\
\textbf{ઓપરેન્ડ} & ઓપરેશનમાં વપરાતી ડેટા વેલ્યુ અથવા એડ્રેસ \\
\textbf{ઈન્સ્ટ્રક્શન સાયકલ} & સૂચના ફેચ અને એક્ઝિક્યુટ કરવાની સંપૂર્ણ પ્રક્રિયા \\
\textbf{ઓપકોડ} & સૂચનાનો પ્રકાર દર્શાવતો ઓપરેશન કોડ \\
\textbf{CU} & પ્રોસેસર ઓપરેશન્સનું સંકલન કરતું કંટ્રોલ યુનિટ \\
\textbf{મશીન સાયકલ} & T-સ્ટેટ્સથી બનેલી મૂળભૂત ઓપરેશન સાયકલ \\
\textbf{CISC} & સમૃદ્ધ સૂચના સેટ સાથેનું કોમ્પ્લેક્સ ઇન્સ્ટ્રક્શન સેટ કમ્પ્યુટર \\
\end{longtable}
}
...
\tightlist
\item
  \textbf{મેમરી}: યુનિક એડ્રેસ સાથે સ્ટોરેજ સેલનો વ્યવસ્થિત એરે
\item
  \textbf{ઓપરેન્ડ}: સૂચનાઓ જેના પર ક્રિયા કરે છે તે ડેટા એલિમેન્ટ
\item
  \textbf{ઈન્સ્ટ્રક્શન સાયકલ}: દરેક સૂચના માટે ફેચ-ડિકોડ-એક્ઝિક્યુટ સિક્વન્સ
\item
  \textbf{ઓપકોડ}: પ્રોસેસરને કયું ઓપરેશન કરવાનું છે તે જણાવતો બાઇનરી કોડ
\end{itemize}
...
\textbf{યાદ રાખવા માટે:} ``MO-ICO-MC:
મેમરી-ઓપરેન્ડ-ઈન્સ્ટ્રક્શન-કંટ્રોલ-ઓપરેશન-મશીન-કોમ્પ્લેક્સ''

\end{solutionbox}
\subsection*{પ્રશ્ન 1(ક OR) [7
ગુણ]}\label{uxaaauxab0uxab6uxaa8-1uxa95-or-7-uxa97uxaa3}

\textbf{i) વ્યાખ્યાયિત કરો: માઇક્રોપ્રોસેસર ii) વોન-ન્યુમેન અને હાર્વર્ડ આર્કિટેક્ચરની
તુલના કરો.}
...
\textbf{8085 માઇક્રોપ્રોસેસરના વિવિધ રજીસ્ટરો સમજાવો.}
...
\textbf{યાદ રાખવા માટે:} ``AGSF: એક્યુમુલેટર-જનરલ-સ્ટેક-ફ્લેગ્સ''

\end{solutionbox}
\subsection*{પ્રશ્ન 2(બ) [4
ગુણ]}\label{uxaaauxab0uxab6uxaa8-2uxaac-4-uxa97uxaa3}

\textbf{ઈન્સ્ટ્રક્શનનું ફેચિંગ, ડીકોડિંગ અને એક્ઝેક્યુશન સમજાવો.}
...
\tightlist
\item
  \textbf{ફેચિંગ}: PC મેમરીને એડ્રેસ મોકલે, સૂચના IR માં લોડ થાય
\item
  \textbf{ડીકોડિંગ}: કંટ્રોલ યુનિટ સૂચના ઓપકોડ અને એડ્રેસિંગ મોડ સમજે
\item
  \textbf{એક્ઝેક્યુશન}: ALU ગાણિતિક/લોજિક કાર્ય કરે, રજિસ્ટર/મેમરી વચ્ચે ડેટા ફેરફાર
  થાય
\end{itemize}
...
(ચાલુ)}\label{uxaaauxab0uxab6uxaa8-2uxa95-7-uxa97uxaa3-uxa9auxab2}

\textbf{આકૃતિની મદદથી 8085 માઇક્રોપ્રોસેસરના બ્લોક ડાયાગ્રામનું વર્ણન કરો.}
...
\tightlist
\item
  \textbf{મુખ્ય કમ્પોનન્ટ્સ}: ALU અને રજિસ્ટર્સ પ્રોસેસિંગ કોર બનાવે છે
\item
  \textbf{કંટ્રોલ પાથ}: સૂચનાઓ રજિસ્ટર, ડિકોડર, કંટ્રોલ યુનિટ મારફતે વહે છે
\item
  \textbf{ડેટા પાથ}: ડેટા બફર્સથી બાહ્ય બસ સુધી/થી ફેરફાર થાય છે
\item
  \textbf{ટાઇમિંગ}: આંતરિક ક્લોક દ્વારા બધા ઓપરેશન્સનું સિંક્રોનાઇઝેશન
\end{itemize}

\textbf{યાદ રાખવા માટે:} ``RAID: રજિસ્ટર્સ-ALU-ઈન્સ્ટ્રક્શન્સ-ડિકોડર્સ''
...
\tightlist
\item
  \textbf{મલ્ટિપ્લેક્સિંગ}: AD0-AD7 પિન્સ અલગ-અલગ સમયે એડ્રેસ અને ડેટા ટ્રાન્સફર કરે છે
\item
  \textbf{ALE સિગ્નલ}: એડ્રેસ લેચ એનેબલ એડ્રેસ ક્યારે પકડવું તે નિયંત્રિત કરે છે
\item
  \textbf{8-બિટ લેચ}: આખા મશીન સાયકલ દરમિયાન લોઅર એડ્રેસ બિટ્સ રાખે છે
\item
  \textbf{ટાઇમિંગ}: ALE પલ્સના હાઈ સ્ટેટ દરમિયાન જ એડ્રેસ માન્ય રહે છે
\end{itemize}
...
\tightlist
\item
  \textbf{એડ્રેસ પિન્સ}: A8-A15 (8) અને મલ્ટિપ્લેક્સ્ડ AD0-AD7 (8) 16-બિટ એડ્રેસિંગ
  માટે
\item
  \textbf{કંટ્રોલ પિન્સ}: પેરિફેરલ ડિવાઇસ માટે ટાઇમિંગ અને કંટ્રોલ સિગ્નલ્સ જનરેટ કરે
\item
  \textbf{ઇન્ટરપ્ટ પિન્સ}: પ્રાયોરિટી લેવલ સાથે હાર્ડવેર ઇન્ટરપ્ટ હેન્ડલિંગ
\item
  \textbf{ક્લોક}: ક્રિસ્ટલ કનેક્શન માટે X1, X2, સિંક્રોનાઇઝેશન માટે CLK
\item
  \textbf{પાવર}: Vcc (+5V) અને Vss (ગ્રાઉન્ડ) પાવર સપ્લાય માટે
\end{itemize}
...
\textbf{8051 માઇક્રોકંટ્રોલરનાં ઇંટરપ્ટ્સ સમજાવો.}
...
\textbf{યાદ રાખવા માટે:} ``ETTES: External-Timer-Timer-External-Serial''
...
\textbf{8051 માઇક્રોકંટ્રોલરનું આંતરિક રેમ ઓર્ગેનાઇઝેશન સમજાવો.}
...
\tightlist
\item
  \textbf{રજિસ્ટર બેન્ક્સ}: 8 રજિસ્ટર્સ (R0-R7)ની 4 બેન્ક્સ PSW દ્વારા સિલેક્ટેબલ
\item
  \textbf{બિટ-એડ્રેસેબલ}: 16 બાઇટ્સ (128 બિટ્સ) વ્યક્તિગત રીતે બિટ તરીકે એડ્રેસેબલ
\item
  \textbf{જનરલ પર્પઝ}: યુઝર વેરિએબલ્સ અને સ્ટેક સ્પેસ
\item
  \textbf{SFRs}: ઉચ્ચ એડ્રેસ પર કંટ્રોલ અને સ્ટેટસ રજિસ્ટર્સ
\end{itemize}

\textbf{યાદ રાખવા માટે:} ``RBBS: રજિસ્ટર્સ બિટ્સ બફર સ્પેશિયલ''

\end{solutionbox}
\subsection*{પ્રશ્ન 3(અ OR) [3
ગુણ]}\label{uxaaauxab0uxab6uxaa8-3uxa85-or-3-uxa97uxaa3}

\textbf{SFRs ને તેમના એડ્રેસ સાથે સૂચિબદ્ધ કરો.}
...
\textbf{યાદ રાખવા માટે:} ``PDPT-SP:
પોર્ટ્સ-ડેટા-પ્રોગ્રામ-ટાઇમર્સ-સીરિયલ-પ્રાયોરિટાઇઝ્ડ''

\end{solutionbox}
\subsection*{પ્રશ્ન 3(બ OR) [4
ગુણ]}\label{uxaaauxab0uxab6uxaa8-3uxaac-or-4-uxa97uxaa3}

\textbf{8051 માઇક્રોકંટ્રોલરના ટાઇમર/કાઉન્ટર્સનો લોજિક ડાયાગ્રામ સમજાવો.}

\begin{solutionbox}

\textbf{ટાઇમર/કાઉન્ટર ડાયાગ્રામ:}
...
\item
  \textbf{કાઉન્ટર}: T0/T1 પિન્સ પર બાહ્ય ઘટનાઓ ગણે
\item
  \textbf{કંટ્રોલ બિટ્સ}: TMOD અને TCON રજિસ્ટર્સમાં સેટ થાય
\item
  \textbf{મોડ્સ}: વિવિધ ટાઇમર કોન્ફિગરેશન (13/16/8-બિટ)
\end{itemize}

\textbf{યાદ રાખવા માટે:} ``TCG: ટાઇમર-કાઉન્ટર-ગેટ''

\end{solutionbox}
\subsection*{પ્રશ્ન 3(ક OR) [7
ગુણ]}\label{uxaaauxab0uxab6uxaa8-3uxa95-or-7-uxa97uxaa3}

\textbf{8051 માઇક્રોકંટ્રોલરનો બ્લોક ડાયાગ્રામ સમજાવો.}
...
(ચાલુ)}\label{uxaaauxab0uxab6uxaa8-4uxa85-3-uxa97uxaa3-uxa9auxab2}

\textbf{ડેટાના બે બાઇટ ઉમેરીને પરિણામ R4 રજિસ્ટરમાં સંગ્રહિત કરવા માટે 8051
એસેમ્બલી લેંગ્વેજ પ્રોગ્રામ લખો.}
...
\textbf{યાદ રાખવા માટે:} ``LLAS: લોડ-લોડ-એડ-સ્ટોર''

\end{solutionbox}
\subsection*{પ્રશ્ન 4(બ) [4
ગુણ]}\label{uxaaauxab0uxab6uxaa8-4uxaac-4-uxa97uxaa3}

\textbf{પોર્ટ-1 અને પોર્ટ-2ના કન્ટેન્ટને OR કરીને પછી પરિણામને બાહ્ય RAM સ્થાન
0200H માં મૂકવા માટે 8051 એસેમ્બલી લેંગ્વેજ પ્રોગ્રામ લખો.}
...
\textbf{યાદ રાખવા માટે:} ``PORT: પોર્ટ-OR-રજિસ્ટર-ટ્રાન્સફર''

\end{solutionbox}
\subsection*{પ્રશ્ન 4(ક) [7
ગુણ]}\label{uxaaauxab0uxab6uxaa8-4uxa95-7-uxa97uxaa3}

\textbf{8051 માઇક્રોકંટ્રોલરના એડ્રેસિંગ મોડ્સની યાદી બનાવો અને ઓછામાં ઓછા એક
...
\textbf{નીચેની ઈન્સ્ટ્રક્શન્સ સમજાવો: (i) DJNZ (ii) POP (iii) CJNE.}
...
\textbf{ઉદાહરણો અને સમજૂતી:}

\begin{itemize}
\tightlist
\item
  \textbf{DJNZ R7, LOOP}: R7 ઘટાડે અને જો R7\neq0 તો LOOP પર જમ્પ કરે
  ...
  \end{itemize}
\item
  \textbf{POP 30H}: સ્ટેકમાંથી ડેટા એડ્રેસ 30H પર કોપી કરે
  ...
  \end{itemize}
\item
  \textbf{CJNE A, \#25H, NOTEQUAL}: A ને 25H સાથે સરખાવે, સમાન ન હોય તો જમ્પ
  કરે

  \begin{itemize}
  \tightlist
  \item
    જો A \textless{} ડેટા હોય તો કેરી ફ્લેગ પણ સેટ કરે
  \end{itemize}
\end{itemize}

\textbf{યાદ રાખવા માટે:} ``DPC: ડેક્રિમેન્ટ-પોપ-કમ્પેર''

\end{solutionbox}
\subsection*{પ્રશ્ન 4(બ OR) [4
ગુણ]}\label{uxaaauxab0uxab6uxaa8-4uxaac-or-4-uxa97uxaa3}

\textbf{12 MHz ની ક્રિસ્ટલ ફ્રિકવન્સી સાથે 8051 માઇક્રોકંટ્રોલર માટે, 4ms નો ડિલેય
જનરેટ કરો.}
...
\tightlist
\item
  દરેક ઇનર લૂપ: 4 સાયકલ \times 250 ફેરા = 1000
\item
  આઉટર લૂપ: 16 ફેરા \times 1000 સાયકલ = 16,000 સાયકલ
\item
...
\textbf{યાદ રાખવા માટે:} ``LNDD: લોડ-NOP-ડેક્રિમેન્ટ-ડેક્રિમેન્ટ''
...
\textbf{ઉદાહરણો સાથે સમજૂતી:}

\begin{enumerate}
\tightlist
\item
  \textbf{ANL A, \#0FH}: હાઈ નિબલ માસ્ક કરે (A = A AND 0FH)
...
A = 05H
  ...
  \end{itemize}
\item
  \textbf{ORL 20H, A}: મેમરીમાં બિટ્સ સેટ કરે (20H = 20H OR A)
...
A = 0AH, પછી: 20H = 5FH
  ...
  \end{itemize}
\item
  \textbf{XRL A, \#55H}: ચોક્કસ બિટ્સ ટોગલ કરે (A = A XOR 55H)
...
A = FFH
  ...
  \end{itemize}
\item
  \textbf{CLR C}: કેરી ફ્લેગ સાફ કરે (C = 0)
  ...
  \end{itemize}
\item
  \textbf{CPL A}: બધા બિટ્સ ઇન્વર્ટ કરે (A = NOT A)
...
A = AAH
  ...
  \end{itemize}
\item
  \textbf{RL A}: એક્યુમુલેટરને એક બિટ ડાબી તરફ રોટેટ કરે
...
A = 0BH (00001011)
  ...
  \end{itemize}
\item
  \textbf{RR A}: એક્યુમુલેટરને એક બિટ જમણી તરફ રોટેટ કરે
...
\textbf{8051 માઇક્રોકંટ્રોલર સાથે પુશ બટન સ્વિચ અને LED ઇન્ટરફેસ કરો.}
...
\begin{verbatim}
AGAIN:  JB    P1.0, LED\_OFF  ; જો P1.0=1 (દબાવેલ નથી), LED બંધ
        SETB  P1.7           ; જો P1.0=0 (દબાવેલ છે), LED ચાલુ
        SJMP  AGAIN          ; પુનરાવર્તન કરો
LED\_OFF:CLR   P1.7           ; LED બંધ કરો
        SJMP  AGAIN          ; પુનરાવર્તન કરો
\end{verbatim}
...
\textbf{યાદ રાખવા માટે:} ``PLIC: પુશ-LED-ઇનપુટ-કંટ્રોલ''

\end{solutionbox}
\subsection*{પ્રશ્ન 5(ક) [7
ગુણ]}\label{uxaaauxab0uxab6uxaa8-5uxa95-7-uxa97uxaa3}

\textbf{માઇક્રોકંટ્રોલર સાથે LCD ઇન્ટરફેસ કરો અને ``HELLO'' દર્શાવવા માટે પ્રોગ્રામ
લખો.}
...
DELAY\_LOOP:
    DJNZ R7, DELAY\_LOOP ; R7=0 થાય ત્યાં સુધી લૂપ
    RET                 ; રિટર્ન
...
\tightlist
\item
  \textbf{ઇનિશિયલાઇઝેશન}: 8-બિટ, 2 લાઇન, કર્સર ઓપ્શન માટે LCD કોન્ફિગર
\item
  \textbf{ડેટા ટ્રાન્સફર}: RS=0 સાથે કમાન્ડ, RS=1 સાથે કેરેક્ટર મોકલાય
\item
  \textbf{કેરેક્ટર્સ}: ASCII વેલ્યુ એક પછી એક મોકલી ટેક્સ્ટ દર્શાવાય
\item
  \textbf{ટાઇમિંગ}: યોગ્ય સિગ્નલ ટાઇમિંગ માટે ડિલે રૂટીન
\end{itemize}
...
\textbf{8051 માઇક્રોકંટ્રોલર સાથે LM35 નું ઇન્ટરફેસિંગ દોરો.}
...
\item
  રિઝોલ્યુશન: 10mV/^\circC \rightarrow 8-બિટ ADC સાથે \textasciitilde0.2^\circC રિઝોલ્યુશન
\end{itemize}

\textbf{યાદ રાખવા માટે:} ``TAC: તાપમાન-એનાલોગ-કન્વર્ટ''
...
\item
  સિંગલ-ચેનલ ઓપરેશન
\item
  \textasciitilde100μs કન્વર્ઝન ટાઇમ
\item
  ઇન્ટરફેસ પ્રોટોકોલ:
