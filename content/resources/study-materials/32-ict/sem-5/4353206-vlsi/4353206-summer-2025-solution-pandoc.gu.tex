...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-6ffe264f.pdf}
...
\tightlist
\item
  \textbf{XOR રિડક્શન}: \passthrough{\lstinline!\^data\_in!} ઇવન પેરિટી આપે
  છે
\item
  \textbf{કોમ્પ્લિમેન્ટ}: \passthrough{\lstinline!\~(\^data\_in)!} ઓડ પેરિટી
  આપે છે
\end{itemize}
