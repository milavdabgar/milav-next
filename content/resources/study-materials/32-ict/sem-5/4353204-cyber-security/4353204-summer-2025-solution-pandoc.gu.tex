...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-ca134ebd.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-ff8d0fe9.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-2aca19b1.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-c51d17df.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-30b5f473.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-d50e10d2.pdf}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{nmap} & નેટવર્ક સ્કેનિંગ &
\passthrough{\lstinline!nmap -sS 192.168.1.1!} \\
\textbf{netcat} & નેટવર્ક કમ્યુનિકેશન &
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-7cb83569.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-15d1e783.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-ab6d717e.pdf}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{રિકોનેસન્સ} & Nmap &
\passthrough{\lstinline!nmap -sn 192.168.1.0/24!} & હોસ્ટ શોધ \\
\textbf{પોર્ટ સ્કેનિંગ} & Nmap &
\passthrough{\lstinline!nmap -sS -O target!} & ખુલ્લા પોર્ટની ઓળખ \\
\textbf{સેવા ગણતરી} & Nmap, બેનર ગ્રેબિંગ &
\passthrough{\lstinline!nmap -sV target!} & સેવા વર્ઝન ડિટેક્શન \\
\textbf{વલ્નરેબિલિટી સ્કેનિંગ} & OpenVAS, Nessus &
\passthrough{\lstinline!openvas-start!} & ઓટોમેટેડ વલ્નરેબિલિટી ડિટેક્શન \\
\textbf{વેબ એપ્લિકેશન પરીક્ષણ} & Nikto, Dirb &
\passthrough{\lstinline!nikto -h target!} & વેબ વલ્નરેબિલિટી સ્કેનિંગ \\
\end{longtable}
}
