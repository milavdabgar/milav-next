...
\textbf{Java ના વિવિધ પ્રકારના Primitive data typeની યાદી આપો.}

\begin{solutionbox}
Java મેમરીમાં સીધા સાદા મૂલ્યો સંગ્રહિત કરવા માટે આઠ primitive
data types આપે છે.
...
\textbf{યોગ્ય ઉદાહરણ સાથે Java Programનું સ્ટ્રક્ચર સમજાવો.}

\begin{solutionbox}
Java પ્રોગ્રામનું સ્ટ્રક્ચર package ડેક્લેરેશન, imports, ક્લાસ
ડેફિનિશન, અને મેથોડ્સ સાથે ચોક્કસ સંગઠનને અનુસરે છે.

\textbf{આકૃતિ: Java પ્રોગ્રામ સ્ટ્રક્ચર}
...
\end{solutionbox}
\begin{mnemonicbox}
``PICOM: Package Import Class Objects Methods
ક્રમમાં''
...
\textbf{Java ના arithmetic operatorsની યાદી આપો. કોઈ પણ ત્રણ arithmetic
operatorsનો ઉપયોગ કરીને Java Program વિકસાવો અને તેનું output બતાવો.}

\begin{solutionbox}
Java માં arithmetic operators સંખ્યાત્મક મૂલ્યો પર ગાણિતિક
કાર્યો કરે છે.
...
\end{solutionbox}
\begin{mnemonicbox}
``SAME: સરવાળો, Addition, Multiply, Exponentiation
મૂળભૂત ઓપરેશન્સ''
...
\textbf{Javaમાં for લૂપ માટેની સિન્ટેક્ષ લખો. ૧ થી ૧૦ વચ્ચે આવતા પ્રાઈમ નંબર શોધવા
માટેનો java કોડ વિકસાવો.}

\begin{solutionbox}
Java માં for લૂપ મૂલ્યોની શ્રેણી પર પુનરાવર્તન માટે કૉમ્પેક્ટ રીત
પ્રદાન કરે છે.
...
\textbf{Procedure-Oriented Programming (POP) અને Object-Oriented
Programming (OOP) ના તફાવતોની યાદી આપો.}

\begin{solutionbox}
Procedure-Oriented અને Object-Oriented Programming મૂળભૂત
રીતે અલગ પ્રોગ્રામિંગ પેરાડાઇમ્સનું પ્રતિનિધિત્વ કરે છે.
...
\tightlist
\item
  \textbf{સંગઠન}: POP ફંક્શન્સમાં વિભાજિત કરે છે; OOP ઓબ્જેક્ટ્સમાં જૂથ બનાવે છે
\item
  \textbf{અભિગમ}: POP ટોપ-ડાઉન અનુસરે છે; OOP બોટમ-અપ અનુસરે છે
\end{itemize}
...
\begin{solutionbox}
Java માં static કીવર્ડ તે ક્લાસના બધા ઓબ્જેક્ટ્સ વચ્ચે શેર થતા
ક્લાસ-લેવલ મેમ્બર્સ બનાવે છે.
...
\texttt{static\ int\ count;} \\
static method & ઓબ્જેક્ટ વગર કૉલ કરી શકાય છે &
\texttt{static\ void\ display()} \\
static block & ક્લાસ લોડ થાય ત્યારે એક્ઝિક્યુટ થાય છે &
\texttt{static\ \{\ //\ code\ \}} \\
static nested class & આઉટર ક્લાસ સાથે જોડાયેલ &
\texttt{static\ class\ Inner\ \{\}} \\
\end{longtable}
}
...
\textbf{Constructorની વ્યાખ્યા આપો. Constructorના વિવિધ પ્રકારોની યાદી આપો.
Parameterized constructor સમજાવવા માટેનો java code વિકસાવો.}

\begin{solutionbox}
Constructor એ વિશેષ મેથડ છે જેનું નામ તેના ક્લાસ સાથે સમાન હોય છે,
જેનો ઉપયોગ ઓબ્જેક્ટ્સ બનાવતી વખતે તેમને પ્રારંભિક મૂલ્ય આપવા માટે થાય છે.
...
\bottomrule\noalign{}
\endlastfoot
Default & કોઈ પેરામીટર નહીં, કમ્પાઇલર દ્વારા બનાવાયેલ &
\texttt{Student()\ \{\}} \\
No-arg & સ્પષ્ટપણે વ્યાખ્યાયિત, પેરામીટર નહીં &
\texttt{Student()\ \{\ name\ =\ "Unknown";\ \}} \\
Parameterized & પેરામીટર સ્વીકારે છે &
\texttt{Student(String\ n)\ \{\ name\ =\ n;\ \}} \\
Copy & બીજા ઓબ્જેક્ટથી ઓબ્જેક્ટ બનાવે &
\texttt{Student(Student\ s)\ \{\ name\ =\ s.name;\ \}} \\
\end{longtable}
}
...
\textbf{java મા મૂળભૂત OOP conceptsની યાદી આપો અને કોઈ પણ એક સમજાવો.}

\begin{solutionbox}
Java વિવિધ મૂળભૂત કન્સેપ્ટ્સ દ્વારા Object-Oriented Programming
નો અમલ કરે છે.
...
\tightlist
\item
  \textbf{ડેટા છુપાવવું}: Private variables બહારથી અપ્રાપ્ય
\item
  \textbf{નિયંત્રિત ઍક્સેસ}: Public methods (getters/setters) દ્વારા
\item
  \textbf{અખંડિતતા}: ડેટા માન્યતા યોગ્ય મૂલ્યો સુનિશ્ચિત કરે છે
\end{itemize}
...
\textbf{યોગ્ય ઉદાહરણ સાથે final કીવર્ડ સમજાવો.}

\begin{solutionbox}
Java માં final કીવર્ડ એન્ટિટીઓમાં ફેરફારોને મર્યાદિત કરે છે,
કોન્સ્ટન્ટ્સ, અપરિવર્તનીય મેથડ્સ, અને નોન-ઇન્હેરિટેબલ ક્લાસ બનાવે છે.
...
\bottomrule\noalign{}
\endlastfoot
final variable & સુધારી શકાતું નથી & \texttt{final\ int\ MAX\ =\ 100;} \\
final method & ઓવરરાઇડ કરી શકાતી નથી &
\texttt{final\ void\ display()\ \{\}} \\
final class & વિસ્તૃત કરી શકાતો નથી & \texttt{final\ class\ Math\ \{\}} \\
final parameter & મેથડમાં બદલી શકાતા નથી &
\texttt{void\ method(final\ int\ x)\ \{\}} \\
\end{longtable}
}
...
\textbf{java access modifierમાટેનો scope લખો. public modifier સમજાવવા
માટેનો java code વિકસાવો.}

\begin{solutionbox}
Java માં access modifiers ક્લાસ, મેથડ્સ, અને વેરિએબલ્સની દૃશ્યતા
અને ઍક્સેસિબિલિટીને નિયંત્રિત કરે છે.
...
\textbf{વિવિધ પ્રકારના inheritance ની યાદી આપો અને કોઈ પણ એક ઉદાહરણ સાથે
સમજાવો.}

\begin{solutionbox}
Inheritance એક ક્લાસને બીજા ક્લાસમાંથી attributes અને
behaviors વારસામાં લેવાની ક્ષમતા આપે છે.
...
Multilevel & Inheritance ની સાંકળ (A\rightarrowB\rightarrowC) \\
...
\textbf{કોઈ પણ બે String buffer class methods યોગ્ય ઉદાહરણ સાથે સમજાવો.}

\begin{solutionbox}
StringBuffer અક્ષરોનો બદલી શકાય તેવો ક્રમ છે જેનો ઉપયોગ
સ્ટ્રિંગ્સને મોડિફાય કરવા માટે થાય છે, વિવિધ હેરફેર મેથડ્સ ઓફર કરે છે.
...
\bottomrule\noalign{}
\endlastfoot
append() & અંતે સ્ટ્રિંગ ઉમેરે છે & \texttt{sb.append(String\ str)} \\
insert() & નિર્દિષ્ટ સ્થાને સ્ટ્રિંગ ઉમેરે છે &
\texttt{sb.insert(int\ offset,\ String\ str)} \\
\end{longtable}
}
...
\textbf{Interfaceની વ્યાખ્યા આપો. Interfaceની મદદથી multiple inheritance
નો java program લખો.}

\begin{solutionbox}
Interface એક કરાર છે જે એવી મેથડ્સ ઘોષિત કરે છે જે એક ક્લાસ અમલ
કરવા માટે જરૂરી છે, જે Java માં multiple inheritance શક્ય બનાવે છે.

\textbf{વ્યાખ્યા:} Interface એ એક રેફરન્સ પ્રકાર છે જેમાં માત્ર કોન્સ્ટન્ટ્સ, મેથડ
સિગ્નેચર્સ, ડિફોલ્ટ મેથડ્સ, સ્ટેટિક મેથડ્સ, અને નેસ્ટેડ પ્રકારો સમાવિષ્ટ છે, જેમાં abstract
મેથડ્સ માટે કોઈ અમલીકરણ નથી.

\textbf{આકૃતિ: Interfaces નો ઉપયોગ કરીને Multiple Inheritance}
...
\textbf{Abstract class અને Interface નો તફાવત આપો.}

\begin{solutionbox}
Abstract class અને interface બંને abstraction માટે વપરાય છે
પરંતુ ઘણા મહત્વપૂર્ણ પાસાઓમાં અલગ પડે છે.
...
\tightlist
\item
  \textbf{અમલીકરણ}: Abstract class આંશિક અમલીકરણ પ્રદાન કરી શકે છે;
  interface પરંપરાગત રીતે કોઈ નહીં
\item
  \textbf{સંબંધ}: Abstract class કહે છે ``is-a''; interface કહે છે
  ``can-do-this''
\end{itemize}
...
\textbf{કોઈ પણ બે String class methods યોગ્ય ઉદાહરણ સાથે સમજાવો.}

\begin{solutionbox}
String ક્લાસ સ્ટ્રિંગ મેનિપ્યુલેશન, કમ્પેરિઝન અને ટ્રાન્સફોર્મેશન માટે
વિવિધ મેથડ્સ આપે છે.
...
\bottomrule\noalign{}
\endlastfoot
substring() & સ્ટ્રિંગનો ભાગ કાઢે છે &
\texttt{str.substring(int\ beginIndex,\ int\ endIndex)} \\
equals() & સ્ટ્રિંગ કન્ટેન્ટની તુલના કરે છે & \texttt{str1.equals(str2)} \\
\end{longtable}
}
...
\textbf{Package સમજાવો અને package create કરવા માટેના સ્ટેપ્સની યાદી બનાવો.}

\begin{solutionbox}
Java માં package એ નેમસ્પેસ છે જે સંબંધિત ક્લાસ અને ઇન્ટરફેસને સંગઠિત
કરે છે, નામકરણ સંઘર્ષોને અટકાવે છે.
...
\textbf{java માં errorના પ્રકારોની યાદી આપો.}

\begin{solutionbox}
Java પ્રોગ્રામ્સ ડેવલપમેન્ટ અને એક્ઝિક્યુશન દરમિયાન વિવિધ errors નો
સામનો કરી શકે છે.
...
Runtime Errors & એક્ઝિક્યુશન દરમિયાન & NullPointerException,
...
\tightlist
\item
  \textbf{Syntax Errors}: સેમિકોલોન, બ્રેકેટ્સની ગેરહાજરી, અથવા ટાઇપો
\item
  \textbf{Semantic Errors}: ટાઇપ મિસમેચિસ, અસંગત ઓપરેશન્સ
\item
  \textbf{Exceptions}: હેન્ડલિંગની જરૂર પડતી રનટાઇમ સમસ્યાઓ
\end{itemize}
...
\textbf{try catch block યોગ્ય ઉદાહરણ સાથે સમજાવો.}

\begin{solutionbox}
Java માં try-catch બ્લોકએ exceptions ને હેન્ડલ કરે છે, જેનાથી ભૂલો
હોવા છતાં પ્રોગ્રામ્સને ચાલુ રાખવાની મંજૂરી મળે છે.

\textbf{આકૃતિ: Try-Catch ફ્લો}
...
\textbf{method overloading અને overriding વચ્ચેના ચાર તફાવત આપો. method
overriding સમજાવવા માટેનો java program લખો.}

\begin{solutionbox}
Method overloading અને overriding બંને polymorphism ના
પ્રકારો છે પરંતુ ફંક્શનાલિટી અને અમલીકરણમાં અલગ પડે છે.
...
\textbf{કોઈ પણ ચાર inbuilt exceptions ની યાદી આપો.}

\begin{solutionbox}
Java ઘણા બિલ્ટ-ઇન exception ક્લાસ પ્રદાન કરે છે જે વિવિધ ભૂલની
...
ArithmeticException & અમાન્ય ગાણિતિક ઓપરેશન (શૂન્ય વડે ભાગાકાર) &
java.lang \\
...
\tightlist
\item
  \textbf{Unchecked}: Runtime exceptions (સ્પષ્ટ હેન્ડલિંગની જરૂર નથી)
\item
  \textbf{Hierarchy}: બધા Exception ક્લાસમાંથી extends થાય છે
\item
  \textbf{Handling}: try-catch બ્લોક્સથી પકડી શકાય છે
\end{itemize}

\end{solutionbox}
\begin{mnemonicbox}
``NAAC: Null Array Arithmetic Cast સામાન્ય
exceptions''
...
\textbf{યોગ્ય ઉદાહરણ સાથે ``throw'' કીવર્ડ સમજાવો.}

\begin{solutionbox}
Java માં throw કીવર્ડ પ્રોગ્રામ્સમાં અસાધારણ સ્થિતિઓ માટે મેન્યુઅલી
exceptions જનરેટ કરે છે.
...
\textbf{`this' કીવર્ડ `Super' કીવર્ડ સાથે સરખાવો. યોગ્ય ઉદાહરણ સાથે super
કીવર્ડ સમજાવો.}

\begin{solutionbox}
`this' અને `super' કીવર્ડ Java માં રેફરન્સિંગ માટે વપરાય છે,
અલગ-અલગ હેતુઓ અને વર્તન સાથે.
...
મેથડ ઇન્વોકેશન & this.method() (વર્તમાન ક્લાસ) & super.method() (પેરન્ટ
ક્લાસ) \\
...
\end{solutionbox}
\begin{mnemonicbox}
``PCIM: Parent Class Inheritance Members with
super''
...
\textbf{વિવિધ Stream Classes ની યાદી આપો.}

\begin{solutionbox}
Java I/O ઇનપુટ અને આઉટપુટ ઓપરેશન્સ માટે વિવિધ સ્ટ્રીમ ક્લાસ પ્રદાન
કરે છે.
...
\tightlist
\item
  \textbf{Byte Streams}: બાઇનરી ડેટા (8-બિટ બાઇટ્સ) સાથે કામ કરે છે
\item
  \textbf{Character Streams}: અક્ષરો (16-બિટ યુનિકોડ) સાથે કામ કરે છે
\item
  \textbf{Buffered Streams}: બફરિંગ દ્વારા પરફોર્મન્સ સુધારે છે
\end{itemize}
...
\textbf{`Divide by Zero' એરર માટે યુઝર ડીફાઇન એક્સેપ્સન હેન્ડલ કરવા માટે જાવા
પ્રોગ્રામ લખો.}

\begin{solutionbox}
યુઝર-ડિફાઈન્ડ exceptions એપ્લિકેશન-સ્પેસિફિક ભૂલની સ્થિતિઓ માટે
કસ્ટમ exception પ્રકારો બનાવવાની મંજૂરી આપે છે.
...
\textbf{જાવામાં એક પ્રોગ્રામ લખો જે બાઈટ બાય બાઈટ ફાઈલના કન્ટેન્ટ વાંચે અને તેને
બીજી ફાઈલ માં કોપી કરે.}

\begin{solutionbox}
Java માં ફાઇલ I/O ઓપરેશન્સ ફાઇલ્સ માંથી વાંચવા અને લખવાની મંજૂરી
આપે છે, બાઇટ સ્ટ્રીમ્સ બાઇનરી ડેટાને હેન્ડલ કરે છે.
...
\textbf{પ્રથમ source.txt ફાઇલ બનાવવી:}
...
public class CreateSourceFile \{
    public static void main(String[] args) \{
        try \{
            ...
            writer.write("This is a sample file.{n}");
            writer.write("It will be copied byte by byte.{n}");
...
\textbf{javaના વિવિધ file operationsની યાદી આપો.}

\begin{solutionbox}
Java વિવિધ ફાઇલ ઓપરેશન્સ દ્વારા વ્યાપક ફાઇલ હેન્ડલિંગ ક્ષમતાઓ
પ્રદાન કરે છે.
...
File Writing & ફાઇલ્સમાં લખવું & FileOutputStream, FileWriter,
PrintWriter \\
File Deletion & ફાઇલ્સ ડિલીટ કરવી & File.delete() \\
File Information & ફાઇલ મેટાડેટા મેળવવા & File methods (length, isFile,
વગેરે) \\
Directory Operations & ડિરેક્ટરીઓ બનાવવી/લિસ્ટ કરવી & File methods (mkdir,
list, વગેરે) \\
File Copy & ફાઇલ કન્ટેન્ટ કોપી કરવા & FileInputStream with
FileOutputStream \\
...
\tightlist
\item
  \textbf{Stream-based}: લો-લેવલ બાઇટ અથવા કેરેક્ટર સ્ટ્રીમ્સ
\item
  \textbf{Reader/Writer}: કેરેક્ટર-ઓરિએન્ટેડ ફાઇલ ઓપરેશન્સ
\item
  \textbf{NIO Package}: એન્હાન્સ્ડ ફાઇલ ઓપરેશન્સ (Java 7થી)
\end{itemize}
...
\textbf{એક્સેપ્સન હેન્ડલિંગ માં finally block સમજાવતો જાવા પ્રોગ્રામ લખો.}

\begin{solutionbox}
Exception હેન્ડલિંગમાં finally બ્લોક છે કે exception થાય કે ન
થાય, કોડ એક્ઝિક્યુશન સુનિશ્ચિત કરે છે.

\textbf{આકૃતિ: try-catch-finally ફ્લો}
...
\textbf{ફાઈલ ક્રિએટ કરવા અને તેમાં લખવા માટેનો જાવા પ્રોગ્રામ લખો.}

\begin{solutionbox}
Java કેરેક્ટર અથવા બાઇટ સ્ટ્રીમ્સનો ઉપયોગ કરીને ફાઇલ્સ બનાવવા અને
તેમાં ડેટા લખવા માટે ઘણી રીતો પ્રદાન કરે છે.
