...
\questionmarks{2(a)}{3}{List out basic concepts of Java OOP. Explain any one in details.}
...
\questionmarks{5(b OR)}{4}{Explain throw and finally in Exception Handling with example.}
