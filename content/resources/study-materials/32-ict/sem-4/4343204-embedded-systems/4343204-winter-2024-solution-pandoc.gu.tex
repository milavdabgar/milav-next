...
void MAX7221\_init() \{
    ...
    MAX7221\_send(0x09, 0xFF);  // ડિકોડ મોડ: બધા ડિજિટ્સ માટે BCD
    MAX7221\_send(0x0A, 0x0F);  // ઇન્ટેન્સિટી: 15/32 ડ્યુટી (મેક્સ)
    MAX7221\_send(0x0B, 0x07);  // સ્કેન લિમિટ: બધા ડિજિટ્સ ડિસ્પ્લે કરો
    MAX7221\_send(0x0C, 0x01);  // શટડાઉન મોડ: નોર્મલ ઓપરેશન
    MAX7221\_send(0x0F, 0x00);  // ડિસ્પ્લે ટેસ્ટ: નોર્મલ ઓપરેશન
\}
\end{verbatim}
