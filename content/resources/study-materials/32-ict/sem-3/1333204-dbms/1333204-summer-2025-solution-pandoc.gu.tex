...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-2eee7d05.pdf}
...
\textbf{CONVERT} & ડેટા પ્રકાર કન્વર્ઝન &
...
\item
  \textbf{સિન્ટેક્સ}: \passthrough{\lstinline!TO\_CHAR(value, format)!}
\item
...
\item
  \textbf{સિન્ટેક્સ}: \passthrough{\lstinline!TO\_DATE(string, format)!}\\
\item
...
\item
  \textbf{સિન્ટેક્સ}: \passthrough{\lstinline!TO\_NUMBER(string, format)!}
\item
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mermaid-55db61de.pdf}
