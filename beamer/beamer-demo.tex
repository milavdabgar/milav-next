...
\begin{frame}
    ...
    \note{
        [click] Narrator: Welcome to the Comprehensive Beamer Feature Showcase.
        [click] Narrator: This document covers not just content, but structure, navigation, and visual styling logic.
    }
\end{frame}
...
\begin{frame}{Table of Contents}
    \tableofcontents
    \note{
        Narrator: A table of contents is crucial for longer presentations. 
        [click] Narrator: Beamer generates this automatically from section commands.
    }
\end{frame}
...
\begin{frame}{Incremental Reveals}
    ...
    \note{
        Narrator: In our first section, Structure and Layout.
        [click] Narrator: We start with incremental reveals to control pacing.
        [click] Narrator: Step two.
        [click] Narrator: And step three.
    }
\end{frame}
...
def fib(n):
    ...
    \note{
        Narrator: Columns are essential for comparisons.
    }
\end{frame}
...
\begin{frame}{Beamer Blocks}
    ...
    \note{
        Narrator: Beamer provides distinct block types.
        [click] Narrator: The standard block.
        [click] Narrator: The alert block for emphasis.
        [click] Narrator: And the examples block.
    }
\end{frame}
...
\begin{frame}{Math \& Equations}
    ...
    \note{
        Narrator: Moving to Rich Content. Math support is first class.
        [click] Narrator: We can reveal derivations step by step.
    }
\end{frame}
...
def calculate_area(radius):
    ...
    \note{
        Narrator: Code evolution is crucial for technical talks.
        [click] Narrator: We update the code in place using overlays.
    }
\end{frame}
...
\begin{frame}{Styled Components}
    ...
    \note{
        Narrator: We can also create custom components like Info Cards.
        [click] Narrator: Or Alert Boxes.
    }
\end{frame}
...
\begin{frame}{Digrams (TikZ)}
    ...
    \note{
        Narrator: Vector diagrams are rendered natively.
        [click] Narrator: And can be highlighted dynamically.
    }
\end{frame}
...
\begin{frame}{Navigation Buttons}
    ...
    \note{
        Narrator: Interactive elements like buttons allow for non-linear presentations.
        [click] Narrator: Typically less used in linear video, but valuable for reference.
    }
\end{frame}
...
\begin{frame}[label=transitions]{Transitions}
    ...
    \note{
        Narrator: Finally, animation.
        Narrator: Use transitions sparingly, but they add polish.
    }
\end{frame}
