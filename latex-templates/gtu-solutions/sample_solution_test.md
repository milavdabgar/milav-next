...
:::: center
::: tabulary
\|L\|L\|L\| **Characteristic** & **Active Components** & **Passive
Components**\
Energy Source & Require external power source & Do not require external
power\
Control Ability & Can control/amplify current flow & Cannot amplify,
only regulate\
Directionality & Usually unidirectional & Bidirectional\
Power Gain & Provide power gain ($>1$) & Power gain is always $\leq 1$\
Examples & Transistors (BJT, FET), Diodes (LED, Zener), ICs (Op-Amp, 555
Timer), SCR & Resistors, Capacitors, Inductors, Transformers\
Function & Amplification, switching, oscillation, rectification &
Resistance, capacitance, inductance, filtering\
...
:::: center
::: circuitikz
(0,0) to\[sV, l=$V_{in}$\] (0,2); (0,2) to\[short\] (2,2);

(2,2) to\[D\*, l=$D$\] (4,2);

(4,2) to\[short\] (5,2); (5,2) to\[R, l=$R_L$\] (5,0); (5,0) to\[short\]
(0,0);

(4.5,2) to\[short, \*-\] (4.5,2.5); at (4.5,2.7) $V_{out}$; (4.5,0)
to\[short, \*-\] (4.5,-0.5); at (4.5,-0.5) ;
:::
::::
