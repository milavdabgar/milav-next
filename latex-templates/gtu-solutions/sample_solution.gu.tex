...
\solutionheading{પગલું 1: Cutoff Frequency ની ગણતરી}
...
\solutionheading{પગલું 2: Cutoff પર Output Voltage}
Cutoff frequency પર, output voltage એ input voltage ના \keyword{0.707 ગણા} (અથવા $\frac{1}{\sqrt{2}}$) હોય છે:
\[V_{out} = 0.707 \times V_{in} = 0.707 \times 10 = 7.07\,V\]

\solutionheading{પરિણામો:}
\begin{itemize}
...
\hline
\solutionheading{લાક્ષણિકતા} & \solutionheading{Active Components} & \solutionheading{Passive Components} \\ \hline
...
\solutionheading{Active Components વિગતવાર:}
\begin{itemize}
...
\solutionheading{Passive Components વિગતવાર:}
\begin{itemize}
...
\solutionheading{કાર્ય સિદ્ધાંત:}
\begin{enumerate}
