...
\subsubsection{ઉકેલ}
ત્રણ નંબરોમાંથી \textbf{મેક્સિમમ} શોધવા માટે, અમે વ્યવસ્થિત રીતે વેલ્યુઝની સરખામણી કરવા માટે \textbf{કન્ડિશનલ સ્ટેટમેન્ટ્સ} (if-else) નો ઉપયોગ કરીએ છીએ. આ પ્રોગ્રામ પ્રોગ્રામિંગમાં વપરાતી મૂળભૂત સરખામણી લોજિક દર્શાવે છે. અમે ત્રણ integer variables ને અલગ-અલગ વેલ્યુઝ સાથે initialize કરીએ છીએ અને તેમાંથી સૌથી મોટી વેલ્યુ શોધવા માટે \emph{પગલું-દર-પગલું સરખામણી પદ્ધતિ} વાપરીએ છીએ. આ પદ્ધતિ કાર્યક્ષમ છે અને શરૂઆત કરનારાઓ માટે સમજવામાં સરળ છે. અલ્ગોરિધમ પ્રથમ બે નંબરોની સરખામણી કરે છે અને મોટો એક સંગ્રહ કરે છે, પછી આ પરિણામને ત્રીજા નંબર સાથે સરખાવીને અંતિમ મેક્સિમમ વેલ્યુ નક્કી કરે છે.
...
\subparagraph{સરખામણી પદ્ધતિઓ:}
ત્રણ પદ્ધતિઓ છે: nested if-else (ઉપર બતાવેલ), ternary operator \texttt{max = (a>b) ? ((a>c)?a:c) : ((b>c)?b:c)}, અથવા built-in \texttt{Math.max()} method.
...
\subsubsection{ઉકેલ}
\textbf{આરસી લો-પાસ ફિલ્ટર} એક passive electronic circuit છે જે નીચી ફ્રિક્વન્સી સિગ્નલોને પસાર થવા દે છે જ્યારે ઊંચી ફ્રિક્વન્સી સિગ્નલોને ઘટાડે છે. \emph{કટઓફ ફ્રિક્વન્સી} એ નિર્ણાયક બિંદુ છે જ્યાં આઉટપુટ પાવર ઇનપુટ પાવર ના અડધા સુધી ઘટે છે, જે લગભગ 70.7\% વોલ્ટેજ ઘટાડાને અનુરૂપ છે. આ ફિલ્ટર નો વ્યાપકપણે ઓડિયો સિસ્ટમ્સ, સિગ્નલ પ્રોસેસિંગ અને noise reduction circuits માં ઉપયોગ થાય છે. Electronic applications માં ચોક્કસ ફ્રિક્વન્સી રિસ્પોન્સ આવશ્યકતાઓને પૂર્ણ કરતા ફિલ્ટર્સ ડિઝાઇન કરવા માટે કટઓફ ફ્રિક્વન્સી ની ગણતરી સમજવી આવશ્યક છે.
...
\textbf{કાર્નોફ મેપ વાપરીને બુલિયન ફંક્શન \(F(A,B,C,D) = \sum m(0,1,2,5,8,9,10)\) ને સરળ કરો.}

\subsubsection{ઉકેલ}

આપેલ બુલિયન ફંક્શન ને \textbf{કાર્નોફ મેપ} (K-map) વાપરીને સરળ કરવા માટે, અમે મિનટર્મ્સ પ્લોટ કરીએ છીએ અને મિનિમલ સમ-ઓફ-પ્રોડક્ટ્સ (SOP) એક્સપ્રેશન શોધવા માટે નજીકના 1s ને ગ્રૂપ કરીએ છીએ.

\paragraph{K-Map રેપ્રેઝન્ટેશન:}
\begin{figure}[H]
\centering
\begin{karnaugh-map}[4][4][1][\(CD\)][\(AB\)]
    ...
    \implicant{8}{10}
\end{karnaugh-map}
\caption{\(F(A,B,C,D)\) માટે K-Map}
\end{figure}

\paragraph{ગ્રૂપિંગ વિશ્લેષણ:}
\begin{description}
    \item[ગ્રૂપ 1 (લાલ):] મિનટર્મ્સ 0, 2, 8, 10 \(\rightarrow B'D'\) (4 સેલ્સ કવર કરે છે)
    \item[ગ્રૂપ 2 (વાદળી):] મિનટર્મ્સ 0, 1 \(\rightarrow A'B'C'\) (2 સેલ્સ કવર કરે છે)
    \item[ગ્રૂપ 3 (લીલો):] મિનટર્મ્સ 8, 9, 10 \(\rightarrow A C'\) (મિનટર્મ 5 આઇસોલેટેડ સાથે 2 સેલ્સ)
\end{description}

\paragraph{સરળીકૃત એક્સપ્રેશન:}
મિનિમલ SOP ફોર્મ છે:
...
\paragraph{વેરિફિકેશન:}
\begin{description}
    \item[ઓરિજિનલ મિનટર્મ્સ:] 7 મિનટર્મ્સ
    \item[ગ્રૂપ્સ ફોર્મ્ડ:] બધા મિનટર્મ્સ કવર કરતા 3 ગ્રૂપ્સ
    \item[લિટરલ્સ સેવ્ડ:] 28 લિટરલ્સ (7 મિનટર્મ્સ \(\times\) 4 લિટરલ્સ) થી 9 લિટરલ્સ
\end{description}

\subparagraph{K-Map નિયમો:}
ગ્રૂપ સાઇઝ 2 ની પાવર હોવા જોઈએ (1, 2, 4, 8, 16). ગ્રૂપ્સ એજીસ આસપાસ રેપ કરી શકે છે. મોટા ગ્રૂપ્સ સરળ ટર્મ્સ આપે છે.
