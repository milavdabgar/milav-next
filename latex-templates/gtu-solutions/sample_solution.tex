...
\begin{quote}
\textbf{MAX: Compare in pairs, update Maximum At eXamination}
\end{quote}
...
\begin{quote}
\textbf{RC-Formula: fc = 1/(2$\pi$ RC), Vout = 0.707 Vin at fc}
\end{quote}
...
\begin{quote}
\textbf{ACTIVE = Amplify, Control, Transform; PASSIVE = Resist, Store, Filter}
\end{quote}
...
\begin{quote}
\textbf{HWR: Half-Wave = Half output, 40.6\% efficiency, PIV = Vm}
\end{quote}
