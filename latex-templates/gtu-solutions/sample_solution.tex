...
\textbf{Calculate the cutoff frequency of an RC low-pass filter with \(R = 1.5\,k\Omega\) and \(C = 100\,nF\). Also find the output voltage if input is 10\,V at cutoff frequency.}
