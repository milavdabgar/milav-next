...
\solutionheading{Output:}
\begin{verbatim}
Maximum number is: 40
\end{verbatim}

\solutionheading{Key Points:}
\begin{itemize}
...
\solutionheading{Step 1: Calculate Cutoff Frequency}
...
\solutionheading{Step 2: Calculate Output Voltage at Cutoff}
...
\solutionheading{Active Components in Detail:}
\begin{itemize}
...
\solutionheading{Passive Components in Detail:}
\begin{itemize}
...
\solutionheading{Key Distinction:}
...
\solutionheading{Circuit Diagram:}
\begin{center}
...
\solutionheading{Working Principle:}
\begin{enumerate}
...
\solutionheading{Waveform Representation:}
\begin{center}
...
\solutionheading{Key Parameters:}
\begin{itemize}
