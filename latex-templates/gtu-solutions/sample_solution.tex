...
\begin{itemize}
    ...
    \item \textbf{ICs}: Integrated circuits like \texttt{555 timer} (oscillator), op-amps (amplifier).
...
\begin{itemize}
    ...
    \item \textbf{Capacitors}: Store energy in electric field. Value in Farads (F), blocks DC, passes AC.
    \item \textbf{Inductors}: Store energy in magnetic field. Value in Henry (H), opposes AC changes.
