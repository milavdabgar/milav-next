# Subject Name (SUBJECT001) - Sample Term Question Paper

| Question | English | Gujarati | Marks |
|----------|---------|----------|-------|
| **Q.1(a)** | Write a Java program to find the maximum of three numbers. | ત્રણ numbers માંથી maximum શોધવા માટે Java program લખો. | 3 |
