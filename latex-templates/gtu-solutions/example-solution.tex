...
% 5. Tables: Caption at TOP, use \captionof{table}{...}.
...
Method Types & Abstract and Concrete & Abstract (and default) \\ \hline
Variables & Any type & \code{public static final} \\ \hline
Inheritance & \code{extends} keyword & \code{implements} keyword \\ \hline
\end{tabularx}
\end{center}
\end{solutionbox}
