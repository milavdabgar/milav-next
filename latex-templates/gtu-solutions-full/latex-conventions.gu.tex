...
\begin{solutionbox}
ડાયાગ્રામ્સ માટે, \code{preamble.tex} માં વ્યાખ્યાયિત ગ્લોબલ \code{gtu} સ્ટાઇલ્સનો ઉપયોગ કરો. કેપ્શન ફિગરની \textbf{નીચે} જાય છે.
...
\begin{tikzpicture}[node distance=1.5cm, auto]
    ...
    \path [gtu arrow] (R) -- (Rn);
\end{tikzpicture}
\captionof{figure}{સરળ થ્રેડ લાઇફ સાઇકલ}
\end{center}
